#line 1 "..\\code\\uCGUI\\Widget\\BUTTON.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\BUTTON.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\BUTTON.c"
#line 1 "..\\code\\uCGUI\\Widget\\BUTTON_Private.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\BUTTON_Private.h"
...
#line 25 "..\\code\\uCGUI\\Widget\\BUTTON_Private.h"
...
#line 41 "..\\code\\uCGUI\\Widget\\BUTTON_Private.h"
...
#line 23 "..\\code\\uCGUI\\Widget\\BUTTON.c"
...
#line 49 "..\\code\\uCGUI\\Widget\\BUTTON.c"
...
static void _Paint(BUTTON_Obj* pObj, BUTTON_Handle hObj) {
  ...
  if (ColorIndex < 2) {
    Index = (pObj->ahDrawObj[1] && PressedState) ? 1 : 0;
  } else {
    Index = pObj->ahDrawObj[2] ? 2 : 0;
  }
  ...
  if (pMsg->Data.p) {   
    if (pState->Pressed) {
      ...
      if (pObj->Widget.State & (1<<8)) {   
        _ButtonReleased(hObj, pObj, 2);
      }
    }
  } else {
    _ButtonReleased(hObj, pObj, 3);
  }
...
#line 261 "..\\code\\uCGUI\\Widget\\BUTTON.c"
...
void BUTTON_Callback(WM_MESSAGE *pMsg) {
  ...
  case 11:
    ...
    _Delete(pObj);
    break;        
#line 311 "..\\code\\uCGUI\\Widget\\BUTTON.c"
  }
  WM_DefaultProc(pMsg);
}
...
void BUTTON_SetFocussable(BUTTON_Handle hObj, int State) {
  if (State) {
    WIDGET_OrState(hObj, (1<<4));
  } else {
    WIDGET_AndState(hObj, (1<<4));
  }
}
