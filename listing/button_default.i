#line 1 "..\\code\\uCGUI\\Widget\\BUTTON_Default.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\BUTTON_Default.c"
...
void BUTTON_SetDefaultTextColor(GUI_COLOR Color, unsigned Index) {
  if (Index < (sizeof(BUTTON__DefaultProps . aTextColor) / sizeof(BUTTON__DefaultProps . aTextColor[0]))) {
...
void BUTTON_SetDefaultBkColor(GUI_COLOR Color, unsigned Index) {
  if (Index < (sizeof(BUTTON__DefaultProps . aBkColor) / sizeof(BUTTON__DefaultProps . aBkColor[0]))) {
