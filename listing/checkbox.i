#line 1 "..\\code\\uCGUI\\Widget\\CHECKBOX.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\CHECKBOX.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\CHECKBOX.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\CHECKBOX.c"
#line 1 "..\\code\\uCGUI\\Widget\\CHECKBOX_Private.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\CHECKBOX_Private.h"
...
#line 25 "..\\code\\uCGUI\\Widget\\CHECKBOX_Private.h"
...
#line 26 "..\\code\\uCGUI\\Widget\\CHECKBOX_Private.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\CHECKBOX.c"
#line 25 "..\\code\\uCGUI\\Widget\\CHECKBOX.c"
...
CHECKBOX_PROPS CHECKBOX__DefaultProps = {
  ...
  ((0<<0) | (3<<2)),
  4,
  &CHECKBOX__abmCheck[0], 
  &CHECKBOX__abmCheck[1]
};
...
#line 103 "..\\code\\uCGUI\\Widget\\CHECKBOX.c"
...
static void _Paint(CHECKBOX_Obj* pObj, CHECKBOX_Handle hObj) {
  ...
  {
    if (pObj->Props.BkColor == 0xFFFFFFF) {
...
static void _CHECKBOX_Callback (WM_MESSAGE *pMsg) {
  ...
  CHECKBOX_Obj* pObj;
  hObj = pMsg->hWin;
  pObj = (CHECKBOX_Obj*) GUI_ALLOC_h2p(hObj);
                                    ...
                                    int WinFlags, int ExFlags, int Id)
{
  ...
  if (CHECKBOX__DefaultProps.BkColor == 0xFFFFFFF) {
    WinFlags |= (1<<0);
  }
  ...
  if (hObj) {
    CHECKBOX_Obj* pObj = (CHECKBOX_Obj*) GUI_ALLOC_h2p(hObj);
