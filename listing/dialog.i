#line 1 "..\\code\\uCGUI\\Widget\\DIALOG.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\DIALOG.c"
...
#line 25 "..\\code\\uCGUI\\Widget\\DIALOG.c"
#line 26 "..\\code\\uCGUI\\Widget\\DIALOG.c"
#line 27 "..\\code\\uCGUI\\Widget\\DIALOG.c"
...
static LCD_COLOR _BkColor = 0xc0c0c0;
...
GUI_HWIN GUI_CreateDialogBox(const GUI_WIDGET_CREATE_INFO* paWidget, int NumWidgets, WM_CALLBACK* cb, GUI_HWIN hParent,
                            int x0, int y0)
{
  GUI_HWIN hDialog = paWidget->pfCreateIndirect(paWidget, hParent, x0, y0, cb);      
  GUI_HWIN hDialogClient = WM_GetClientWindow(hDialog);
  ...
  while (--NumWidgets > 0) {
    GUI_HWIN hChild;
    paWidget++;
    hChild = paWidget->pfCreateIndirect(paWidget, hDialogClient, 0, 0, 0);      
    WM_ShowWindow(hChild);
  }
  WM_SetFocusOnNextChild(hDialog);      
  WM_SendMessageNoPara(hDialogClient, 30);
  return hDialog;
}
...
void GUI_EndDialog(GUI_HWIN hDialog, int r) {
...
int GUI_ExecDialogBox(const GUI_WIDGET_CREATE_INFO* paWidget,
                      int NumWidgets, WM_CALLBACK* cb, GUI_HWIN hParent, int x0, int y0)
{
  GUI_HWIN hDialog;
