#line 1 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
#line 1 "..\\code\\uCGUI\\Widget\\DROPDOWN_Private.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\DROPDOWN_Private.h"
...
#line 25 "..\\code\\uCGUI\\Widget\\DROPDOWN_Private.h"
#line 26 "..\\code\\uCGUI\\Widget\\DROPDOWN_Private.h"
...
typedef struct {
  WIDGET  Widget;
  signed short     Sel;                         
  signed short     ySizeEx;                     
  signed short     TextHeight;
  GUI_ARRAY Handles;
...
#line 25 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
#line 26 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
#line 27 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
#line 28 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
#line 1 "..\\code\\GUI\\GUI_inc\\GUI_Protected.h"
...
#line 29 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
#line 30 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
...
#line 31 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
...
#line 115 "..\\code\\uCGUI\\Widget\\DROPDOWN.c"
...
static signed short _GethItem(DROPDOWN_Obj* pObj, int Index) {
...
static const char* _GetpItem(DROPDOWN_Obj* pObj, int Index) {
  const char* s = 0;
  signed short h = _GethItem(pObj, Index);
  if (h) {
...
static void _SelectByKey(DROPDOWN_Handle hObj, int Key) {
  int i;
  DROPDOWN_Obj* pObj;
  pObj = (DROPDOWN_Obj*) GUI_ALLOC_h2p(hObj);
  Key = _Tolower(Key);
...
static int _OnTouch(DROPDOWN_Handle hObj, WM_MESSAGE*pMsg) {
  ...
  if (pMsg->Data.p) {   
    if (pState->Pressed) {
      WM_NotifyParent(hObj, 1);
    } else {
      WM_NotifyParent(hObj, 2);
    }
  } else {      
    WM_NotifyParent(hObj, 3);
  }
  return 0;  
}
...
static void _DROPDOWN_Callback (WM_MESSAGE*pMsg) {
  ...
  DROPDOWN_Obj* pObj = (DROPDOWN_Obj*) GUI_ALLOC_h2p(hObj);
...
void DROPDOWN_Expand(DROPDOWN_Handle hObj) {
  ...
  if (hObj) {
    ...
    if  (pObj->hListWin == 0) {
      ...
      hLst = LISTBOX_CreateAsChild(0, WM_GetParent(hObj), r.x0, r.y0
                         , xSize, ySize, (1<<1));
      if (pObj->Flags & (1 << 0)) {
      ...
      for (i = 0; i < (sizeof(pObj->Props . aBackColor) / sizeof(pObj->Props . aBackColor[0])); i++) {
        LISTBOX_SetBkColor(hLst, i, pObj->Props.aBackColor[i]);
      }
      for (i = 0; i < (sizeof(pObj->Props . aTextColor) / sizeof(pObj->Props . aTextColor[0])); i++) {
...
void DROPDOWN_SetBkColor(DROPDOWN_Handle hObj, unsigned int Index, GUI_COLOR color) {
  DROPDOWN_Obj* pObj;
  if (hObj) {
    if (Index < (sizeof(pObj->Props . aBackColor) / sizeof(pObj->Props . aBackColor[0]))) {
      ;
      pObj = (DROPDOWN_Obj*) GUI_ALLOC_h2p(hObj);
      ;
