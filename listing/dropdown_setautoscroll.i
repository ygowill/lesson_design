#line 1 "..\\code\\uCGUI\\Widget\\DROPDOWN_SetAutoScroll.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\DROPDOWN_SetAutoScroll.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\DROPDOWN_SetAutoScroll.c"
...
void DROPDOWN_SetAutoScroll(DROPDOWN_Handle hObj, int OnOff) {
  if (hObj) {
    ...
    if (pObj->Flags != Flags) {
      pObj->Flags = Flags;
      if (pObj->hListWin) {
        LISTBOX_SetAutoScrollV(pObj->hListWin, (Flags & (1 << 0)) ? 1 : 0);
      }
    }
    ;
  }
