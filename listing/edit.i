#line 1 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
#line 26 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
#line 27 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
#line 28 "..\\code\\uCGUI\\Widget\\EDIT.c"
#line 1 "..\\code\\uCGUI\\Widget\\EDIT_Private.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\EDIT_Private.h"
...
struct EDIT_Obj_struct {
  ...
  signed long Min, Max;             
  unsigned char NumDecs;               
  unsigned long CurrentValue;         
  int CursorPos;            
  unsigned SelSize;         
  unsigned char EditMode;              
  unsigned char XSizeCursor;           
  unsigned char Flags;
...
#line 79 "..\\code\\uCGUI\\Widget\\EDIT_Private.h"
...
unsigned short  EDIT__GetCurrentChar (EDIT_Obj* pObj);

#line 29 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
#line 104 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
#line 127 "..\\code\\uCGUI\\Widget\\EDIT.c"
...
static void _Paint(EDIT_Obj* pObj, EDIT_Handle hObj) {
  ...
  rInside = rFillRect;
  rInside.x0 += pObj->Props.Border + 1;
  rInside.x1 -= pObj->Props.Border + 1;
  GUI__CalcTextRect(pText, &rInside, &rText, pObj->Props.Align);
   
  if (pObj->Widget.State & (1<<0)) {
    const char  * p = pText;
    CursorWidth = ((pObj->XSizeCursor > 0) ? (pObj->XSizeCursor) : (1));
    if (pText) {
      unsigned short Char;
      int i;
      if ((pObj->EditMode != 0) || (pObj->SelSize)) {
...
void EDIT_SetCursorAtPixel(EDIT_Handle hObj, int xPos) {
  if (hObj) {
    ...
    if (pObj->hpText) {    
      ...
      switch (pObj->Props.Align & (3<<0)) {
      case (2<<0):
        xPos -= (xSize - TextWidth + 1) / 2;
        break;
      case (1<<0):
        xPos -= xSize - TextWidth - (pObj->Props.Border + 1);
        break;
      default:
        xPos -= (pObj->Props.Border + 1) + pObj->Widget.pEffect->EffectSize;
      }
      NumChars = GUI__GetNumChars(pText);
      if (xPos < 0) {
...
static int _InsertChar(EDIT_Handle hObj, EDIT_Obj* pObj, unsigned short Char) {
...
EDIT_Handle EDIT_CreateEx(int x0, int y0, int xsize, int ysize, GUI_HWIN hParent, int WinFlags, int ExFlags,
                          int Id, int MaxLen)
{
  EDIT_Handle hObj;
  ExFlags=ExFlags;;
  ...
  WinFlags |= (1<<12);     
  hObj = WM_CreateWindowAsChild(x0, y0, xsize, ysize, hParent, (1<<1) | WinFlags, EDIT__Callback,
...
void EDIT_SetBkColor(EDIT_Handle hObj, unsigned int Index, GUI_COLOR color) {
  ...
  pObj = ((EDIT_Obj*)GUI_ALLOC_h2p(hObj));
  if (pObj) {
    if (Index < (sizeof(pObj->Props . aBkColor) / sizeof(pObj->Props . aBkColor[0]))) {
...
void EDIT_SetTextColor(EDIT_Handle hObj, unsigned int Index, GUI_COLOR color) {
  ...
  pObj = ((EDIT_Obj*)GUI_ALLOC_h2p(hObj));
  if (pObj) {
    if (Index < (sizeof(pObj->Props . aTextColor) / sizeof(pObj->Props . aTextColor[0]))) {
...
void EDIT_SetValue(EDIT_Handle hObj, signed long Value) {
  ...
  if (hObj) {
    ...
    if (pObj->CurrentValue != (unsigned long)Value) {
