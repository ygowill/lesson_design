#line 1 "..\\code\\uCGUI\\Widget\\EDIT_Default.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\EDIT_Default.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\EDIT_Default.c"
...
void EDIT_SetDefaultTextColor(unsigned int Index, GUI_COLOR Color) {
  if (Index <= (sizeof(EDIT__DefaultProps . aTextColor) / sizeof(EDIT__DefaultProps . aTextColor[0]))) {
...
void EDIT_SetDefaultBkColor(unsigned int Index, GUI_COLOR Color) {
  if (Index <= (sizeof(EDIT__DefaultProps . aBkColor) / sizeof(EDIT__DefaultProps . aBkColor[0]))) {
