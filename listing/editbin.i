#line 1 "..\\code\\uCGUI\\Widget\\EDITBin.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\EDITBin.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\EDITBin.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\EDITBin.c"
...
#line 25 "..\\code\\uCGUI\\Widget\\EDITBin.c"
...
#line 26 "..\\code\\uCGUI\\Widget\\EDITBin.c"
...
static int _GetNumDigits(unsigned long Value) {
  int Ret;
...
static void _EditBin(unsigned char Bit, EDIT_Obj* pObj, EDIT_Handle hObj) {
  int Pos = pObj->MaxLen - pObj->CursorPos - 1;    
  unsigned long AndMask = ~(1   << Pos);
  unsigned long OrMask  =   Bit << Pos;
  signed long Result  = pObj->CurrentValue & AndMask;
  Result     |= OrMask;
...
static unsigned char _GetCurrentBit(EDIT_Obj* pObj) {
  int Pos = pObj->MaxLen - pObj->CursorPos - 1;    
  unsigned long AndMask = 1 << Pos;
  unsigned char Bit = (pObj->CurrentValue & AndMask) >> Pos;
  return Bit;
}
...
void EDIT_SetBinMode(EDIT_Handle hEdit, unsigned long Value, unsigned long Min, unsigned long Max) {
  ...
  ;
  if (hEdit) {
    pObj = ((EDIT_Obj*)GUI_ALLOC_h2p(hEdit));
