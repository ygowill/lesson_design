#line 1 "..\\code\\uCGUI\\Widget\\EDITDec.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\EDITDec.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\EDITDec.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\EDITDec.c"
...
#line 25 "..\\code\\uCGUI\\Widget\\EDITDec.c"
...
#line 26 "..\\code\\uCGUI\\Widget\\EDITDec.c"
...
static void _UpdateBuffer(EDIT_Handle hObj) {
  ...
  if (pObj->Flags == 1) {
    signed long Result = GUI_AddSign(pObj->CurrentValue, &s);
...
static void _MakePositive(EDIT_Obj* pObj, EDIT_Handle hObj) {
  if ((signed long)pObj->CurrentValue < 0) {
    EDIT_SetValue(hObj, (signed long)pObj->CurrentValue * -1);
  }
}
...
static void _AddPosition(EDIT_Obj* pObj, EDIT_Handle hObj, int Sign) {
  ...
  EDIT_SetValue(hObj, (signed long)pObj->CurrentValue + v);
}
  ...
  if (pObj) {
    switch (Key) {
      ...
      case '-':
        ...
        break;
#line 228 "..\\code\\uCGUI\\Widget\\EDITDec.c"
        case 17:
