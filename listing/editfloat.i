#line 1 "..\\code\\uCGUI\\Widget\\EDITFloat.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\EDITFloat.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\EDITFloat.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\EDITFloat.c"
...
#line 25 "..\\code\\uCGUI\\Widget\\EDITFloat.c"
...
#line 26 "..\\code\\uCGUI\\Widget\\EDITFloat.c"
...
float EDIT_GetFloatValue(EDIT_Handle hObj) {
  ...
  if (hObj) {
    ...
    Value = (float)(signed long)pObj->CurrentValue / Scale;
    ;
  }
  return Value;
}
...
void EDIT_SetFloatValue(EDIT_Handle hObj, float Value) {
  if (hObj) {
    ...
    Scale = (float)GUI_Pow10[pObj->NumDecs];
    Value *= Scale;
    EDIT_SetValue(hObj, (signed long)(Value + (Value >= 0 ? 0.5 : -0.5)));
    ;
  }
}
