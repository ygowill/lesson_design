#line 1 "..\\code\\uCGUI\\Widget\\FRAMEWIN_ButtonMin.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\FRAMEWIN_ButtonMin.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\FRAMEWIN_ButtonMin.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\FRAMEWIN_ButtonMin.c"
...
#line 25 "..\\code\\uCGUI\\Widget\\FRAMEWIN_ButtonMin.c"
...
#line 26 "..\\code\\uCGUI\\Widget\\FRAMEWIN_ButtonMin.c"
...
static void _Draw(void) {
  ...
  pObj = (FRAMEWIN_Obj*) GUI_ALLOC_h2p(hWin);
  if (pObj->Flags & (1<<6)) {
    _DrawRestore();
  } else {
    _DrawMin();
...
GUI_HWIN FRAMEWIN_AddMinButton(FRAMEWIN_Handle hObj, int Flags, int Off) {
  GUI_HWIN hButton;
  hButton = FRAMEWIN_AddButton(hObj, Flags, Off, 8);
