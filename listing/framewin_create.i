#line 1 "..\\code\\uCGUI\\Widget\\FRAMEWIN_Create.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\FRAMEWIN_Create.c"
...
FRAMEWIN_Handle FRAMEWIN_Create(const char* pText, WM_CALLBACK* cb, int Flags,
  ...
  return FRAMEWIN_CreateEx(x0, y0, xsize, ysize, (0), Flags, 0, 0, pText, cb);
}
...
FRAMEWIN_Handle FRAMEWIN_CreateAsChild(int x0, int y0, int xsize, int ysize, GUI_HWIN hParent,
