#line 1 "..\\code\\uCGUI\\Widget\\FRAMEWIN_Default.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\FRAMEWIN_Default.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\FRAMEWIN_Default.c"
...
void FRAMEWIN_SetDefaultBarColor(unsigned Index, GUI_COLOR Color) {
  if (Index < (sizeof(FRAMEWIN__DefaultProps . aBarColor) / sizeof(FRAMEWIN__DefaultProps . aBarColor[0]))) {
...
void FRAMEWIN_SetDefaultTextColor(unsigned Index, GUI_COLOR Color) {
  if (Index < (sizeof(FRAMEWIN__DefaultProps . aTextColor) / sizeof(FRAMEWIN__DefaultProps . aTextColor[0]))) {
