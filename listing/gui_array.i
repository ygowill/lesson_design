#line 1 "..\\code\\uCGUI\\Widget\\GUI_ARRAY.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\GUI_ARRAY.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\GUI_ARRAY.c"
...
int GUI_ARRAY_AddItem(GUI_ARRAY* pThis, const void *pNew, int Len) {
  ...
  if (r == 0) {
    ...
    hNewBuffer = GUI_ALLOC_Realloc(pThis->haHandle, (NumItems + 1) * sizeof(signed short));
    if (hNewBuffer == 0) {
      ;
...
void GUI_ARRAY_Delete(GUI_ARRAY* pThis) {
  ...
  ha = pThis->haHandle;
  if (ha) {
    pa = (signed short*) GUI_ALLOC_h2p(ha);
...
#line 327 "..\\code\\uCGUI\\Widget\\GUI_ARRAY.c"
