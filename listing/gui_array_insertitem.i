#line 1 "..\\code\\uCGUI\\Widget\\GUI_ARRAY_InsertItem.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\GUI_ARRAY_InsertItem.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\GUI_ARRAY_InsertItem.c"
...
char GUI_ARRAY_InsertBlankItem(GUI_ARRAY* pThis, unsigned int Index) {
  ...
  if (Index >= (unsigned)pThis->NumItems) {
    ...
    signed short hNewBuffer;
    hNewBuffer = GUI_ALLOC_AllocZero(sizeof(signed short) * (pThis->NumItems + 1));
    if (hNewBuffer == 0) {
      ;
    } else {
      signed short *pOldBuffer;
      signed short *pNewBuffer;
      pNewBuffer = (signed short*) GUI_ALLOC_h2p(hNewBuffer);
      pOldBuffer = (signed short*) GUI_ALLOC_h2p(pThis->haHandle);
      memcpy(pNewBuffer, pOldBuffer, Index * sizeof(signed short));
      memcpy(pNewBuffer + (Index + 1), pOldBuffer + Index, (pThis->NumItems - Index) * sizeof(signed short));
