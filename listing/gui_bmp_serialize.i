#line 1 "..\\code\\uCGUI\\Core\\GUI_BMP_Serialize.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_BMP_Serialize.c"
...
static void _SendU16(GUI_CALLBACK_VOID_U8_P * pfSerialize, unsigned short Data, void * p) {
  (*pfSerialize)((unsigned char)Data, p);
...
static void _SendU32(GUI_CALLBACK_VOID_U8_P * pfSerialize, unsigned long Data, void * p) {
  _SendU16(pfSerialize, (unsigned short)Data, p);
...
void GUI_BMP_SerializeEx(GUI_CALLBACK_VOID_U8_P * pfSerialize, int x0, int y0, int xSize, int ySize, void * p) {
  int x, y, i;
  unsigned long BitmapOffset, FileSize;
  ...
  FileSize       = BitmapOffset
                 + ySize * BytesPerLine;
  _SendU16(pfSerialize, ((unsigned short) ('M' << 8) | 'B'), p);        
  _SendU32(pfSerialize, FileSize, p);                 
  _SendU32(pfSerialize, 0, p);                        
  _SendU32(pfSerialize, BitmapOffset, p);             
   
  _SendU32(pfSerialize, 40, p);  
  _SendU32(pfSerialize, xSize, p);                    
  _SendU32(pfSerialize, ySize, p);                    
  _SendU16(pfSerialize, 1, p);                        
  _SendU16(pfSerialize, (BPP  <= 8) ? 8 : 16, p);     
  _SendU32(pfSerialize, 0, p);                        
  _SendU32(pfSerialize, 0, p);                        
  _SendU32(pfSerialize, 0, p);                        
  _SendU32(pfSerialize, 0, p);                        
  _SendU32(pfSerialize, NumColors, p);                
  _SendU32(pfSerialize, 0, p);                        
  ...
  for (y = ySize - 1; y >= 0; y--) {
    for (x = 0; x < xSize; x++) {
      if (BPP <= 8) {
        ...
        unsigned long Color = LCD_GetPixelColor(x0 + x, y0 + y);
