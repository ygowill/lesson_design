#line 1 "..\\code\\uCGUI\\Core\\GUI_DispStringInRectEx.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_DispStringInRectEx.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUI_DispStringInRectEx.c"
...
#line 24 "..\\code\\uCGUI\\Core\\GUI_DispStringInRectEx.c"
...
static const tLCD_APIList * _SetRotation(const tLCD_APIList* pLCD_Api) {
  const tLCD_APIList * pLCD_ApiOld;
  ;
  pLCD_ApiOld = GUI_pLCD_APIList;
  if (pLCD_Api) {
    GUI_Context.pClipRect_HL = 0;            
  } else {
...
void GUI_DispStringInRectEx(const char  *s, GUI_RECT* pRect, int TextAlign, int MaxLen, const tLCD_APIList * pLCD_Api) {
  ...
  if (pLCD_Api == 0) {
    ...
    pLCD_ApiOld = _SetRotation(pLCD_Api);                 
    pLCD_Api->pfRect2TextRect(&rText);                    
