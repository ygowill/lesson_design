#line 1 "..\\code\\uCGUI\\Core\\GUI_DrawBitmapEx.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_DrawBitmapEx.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUI_DrawBitmapEx.c"
...
static void GL_DrawBitmapEx(const GUI_BITMAP  * pBitmap, int x0, int y0,
                            int xCenter, int yCenter, int xMag, int yMag) {
  unsigned short Index, IndexPrev = 0;
  LCD_COLOR Color;
  ...
  x0      -= (signed long)((xMag < 0) ? xSize - xCenter - 1 : xCenter) * (signed long)(xMagAbs) / (signed long)(1000);
  yEnd     = y0 + GUI__DivideRound32(((signed long)(-yCenter) * (signed long)(yMag)), 1000);
  yPrev    = yEnd + 1;
  yStep = (yMag < 0) ? -1 : 1;
  if (pBitmap->pPal) {
  ...
  for (yi = 0; yi < ySize; yi++) {
    y = yEnd;
    yEnd = y0 + GUI__DivideRound32(((signed long)(yi + 1 - yCenter) * (signed long)(yMag)), 1000);
    if (y != yPrev) {
      yPrev = y;
      do {
        if ((y >= yMin) && (y <= yMax)) {
            ...
            if (xiMag >= 1000) {
              ...
              if (Index != IndexPrev || xStart == -1) {
                if ((Index == 0) && HasTrans) {
                  ...
                  LCD_SetColorIndex(LCD_L0_Color2Index(Color));
                }
                IndexPrev = Index;
              }
              do {
...
void GUI_DrawBitmapEx(const GUI_BITMAP  * pBitmap, int x0, int y0,
                      int xCenter, int yCenter, int xMag, int yMag) {
  GUI_COLOR OldColor;
  ...
  OldColor = GUI_GetColor();
    ...
    if (xMag >= 0) {
      r.x0 = x0 + GUI__DivideRound32(((signed long)(-xCenter) * (signed long)(xMag)), 1000);
      r.x1 = x0 + GUI__DivideRound32(((signed long)(pBitmap->XSize - xCenter - 1) * (signed long)(xMag)), 1000);
    } else {
      r.x1 = x0 + GUI__DivideRound32(((signed long)(-xCenter) * (signed long)(xMag)), 1000);
      r.x0 = x0 + GUI__DivideRound32(((signed long)(pBitmap->XSize - xCenter - 1) * (signed long)(xMag)), 1000);
    }
    if (yMag >= 0) {
      r.y0 = y0 + GUI__DivideRound32(((signed long)(-yCenter) * (signed long)(yMag)), 1000);
      r.y1 = y0 + GUI__DivideRound32(((signed long)(pBitmap->YSize - yCenter - 1) * (signed long)(yMag)), 1000);
    } else {
      r.y1 = y0 + GUI__DivideRound32(((signed long)(-yCenter) * (signed long)(yMag)), 1000);
      r.y0 = y0 + GUI__DivideRound32(((signed long)(pBitmap->YSize - yCenter - 1) * (signed long)(yMag)), 1000);
    }
