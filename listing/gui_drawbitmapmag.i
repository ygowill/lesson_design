#line 1 "..\\code\\uCGUI\\Core\\GUI_DrawBitmapMag.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_DrawBitmapMag.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUI_DrawBitmapMag.c"
...
void GUI_DrawBitmapMag(const GUI_BITMAP  *pBitmap, int x0, int y0, int xMul, int yMul) {
  ...
  PrevDraw = GUI_SetDrawMode((pPal && pPal->HasTrans) ? (1<<1) : 0);
  ...
  if (pBitmap->pMethods) {
      ...
      pBitmap->pMethods->pfDraw(x0, y0, pBitmap->XSize ,pBitmap->YSize, (unsigned char const *)pBitmap->pData, pBitmap->pPal, xMul, yMul);
