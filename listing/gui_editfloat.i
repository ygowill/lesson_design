#line 1 "..\\code\\uCGUI\\Widget\\GUI_EditFloat.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\GUI_EditFloat.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\GUI_EditFloat.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\GUI_EditFloat.c"
...
float GUI_EditFloat(float Value, float Min, float Max, int Len, int xsize, int Shift, unsigned char Flags) {
  ...
  } while ((Key != 27) && (Key != 13) && (Key != 0));
  GUI_SetFont(pOldFont);
  Ret = (signed long)pObj->CurrentValue / (float)GUI_Pow10[pObj->NumDecs];
