#line 1 "..\\code\\uCGUI\\Core\\GUI_MergeRect.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_MergeRect.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUI_MergeRect.c"
...
void GUI_MergeRect(GUI_RECT* pDest, const GUI_RECT* pr0, const GUI_RECT* pr1) {
  if (pDest) {
    if (pr0 && pr1) {
      pDest->x0 = ((pr0->x0>pr1->x0) ? pr1->x0 : pr0->x0);
      pDest->y0 = ((pr0->y0>pr1->y0) ? pr1->y0 : pr0->y0);
      pDest->x1 = ((pr0->x1>pr1->x1) ? pr0->x1 : pr1->x1);
      pDest->y1 = ((pr0->y1>pr1->y1) ? pr0->y1 : pr1->y1);
      return;
    }
    *pDest = *(pr0 ? pr0 : pr1);
  }
