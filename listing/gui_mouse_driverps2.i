#line 1 "..\\code\\uCGUI\\Core\\GUI_MOUSE_DriverPS2.c"
...
#line 24 "..\\code\\uCGUI\\Core\\GUI_MOUSE_DriverPS2.c"
...
#line 25 "..\\code\\uCGUI\\Core\\GUI_MOUSE_DriverPS2.c"
...
static int  _NumBytesInBuffer     = 0;     
static unsigned char   _Buttons              = 0;     
static unsigned char   _abInBuffer[3];                
...
static void _EvaPacket(void) {
  ...
  if (_ScreenX < 0) {
    _ScreenX = 0;
  } else if (_ScreenX > (400)-1) {
    _ScreenX = (400)-1;
  } if (_ScreenY < 0) {
    _ScreenY = 0;
  } else if (_ScreenY > (240)-1) {
    _ScreenY = (240)-1;
  }
