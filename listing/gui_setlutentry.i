#line 1 "..\\code\\uCGUI\\Core\\GUI_SetLUTEntry.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_SetLUTEntry.c"
...
void GUI_SetLUTEntry(unsigned char Pos, LCD_COLOR Color) {
  ;
  LCD_L0_SetLUTEntry(Pos, Color);
  ;
}
