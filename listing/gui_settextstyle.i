#line 1 "..\\code\\uCGUI\\Core\\GUI_SetTextStyle.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_SetTextStyle.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUI_SetTextStyle.c"
...
#line 23 "..\\code\\uCGUI\\Core\\GUI_SetTextStyle.c"
...
static void GUI__cbDrawTextStyle(unsigned short Char) {
  int x0, x1;
  x1 = GUI_Context.DispPosX - 1;
  x0 = x1 - GUI_Context.pAFont->pfGetCharDistX(Char) + 1;
   
  if (GUI_Context.TextStyle & (1 << 0)) {
...
char GUI_SetTextStyle(char Style) {
  ...
  GUI_pfDispCharStyle = GUI__cbDrawTextStyle;     
