#line 1 "..\\code\\uCGUI\\Core\\GUI_UC_EncodeUTF8.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUI_UC_EncodeUTF8.c"
...
static unsigned short _GetCharCode(const char  * s) {
  unsigned short r;
  unsigned char Char = *(const unsigned char*)s;
  if ((Char & 0x80) == 0) {                 
    r = Char;
...
static int _CalcSizeOfChar(unsigned short Char) {
  int r;
  if (Char & 0xF800) {                 
    r = 3;
  } else if (Char & 0xFF80) {          
...
static int _Encode(char *s, unsigned short Char) {
  int r;
