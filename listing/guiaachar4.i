#line 1 "..\\code\\uCGUI\\AntiAlias\\GUIAAChar4.c"
...
#line 21 "..\\code\\uCGUI\\AntiAlias\\GUIAAChar4.c"
...
#line 25 "..\\code\\uCGUI\\AntiAlias\\GUIAAChar4.c"
...
#line 26 "..\\code\\uCGUI\\AntiAlias\\GUIAAChar4.c"
...
static void Draw(int x0, int y0, int XSize, int YSize, int BytesPerLine, const unsigned char*pData) {
  ...
  for (y=0; y<YSize; y++) {
    ...
    for (x=0; x<XSize-1; x+=2) {
      (*pfSetPixelAA)(x+x0,y0+y,   (*pData0)>>4);  
...
void GUIPROP_AA4_DispChar(unsigned short c) {
  int BytesPerLine;
...
int GUIPROP_AA4_GetCharDistX(unsigned short c) {
  const GUI_FONT_PROP* pProp = GUIPROP_FindChar(GUI_Context.pAFont->p.pProp, c);
...
char GUIPROP_AA4_IsInFont(const GUI_FONT * pFont, unsigned short c) {
