#line 1 "..\\code\\uCGUI\\AntiAlias\\GUIAACircle.c"
...
#line 25 "..\\code\\uCGUI\\AntiAlias\\GUIAACircle.c"
...
#line 27 "..\\code\\uCGUI\\AntiAlias\\GUIAACircle.c"
...
#line 28 "..\\code\\uCGUI\\AntiAlias\\GUIAACircle.c"
...
#line 29 "..\\code\\uCGUI\\AntiAlias\\GUIAACircle.c"
...
static void FillCircle(int x0, int y0, int r) {
  ...
  for (i=0, x=r; i<r; i++) {
    ...
    if ((y >= yMin) && (y <= yMax)) {
      ...
      while ((i*i+x*x) >sqmax)
        --x;
      GUI_Context . pLCD_HL->pfDrawHLine (x0-x, y, x0+x);
    }
  }
