#line 1 "..\\code\\uCGUI\\AntiAlias\\GUIAALib.c"
...
#line 21 "..\\code\\uCGUI\\AntiAlias\\GUIAALib.c"
#line 22 "..\\code\\uCGUI\\AntiAlias\\GUIAALib.c"
...
#line 26 "..\\code\\uCGUI\\AntiAlias\\GUIAALib.c"
...
#line 27 "..\\code\\uCGUI\\AntiAlias\\GUIAALib.c"
...
static unsigned char   abAABuffer[(400)];    
static unsigned char*  pabAABuffer;
static int  _x0, _x1, _y, _x0_InUse, _x1_InUse;
static GUI_RECT ClipRect_HL;

static tLCD_HL_APIList           DrawAPICopy;     
static const tLCD_HL_APIList*    pLCD_HLPrev;     
...
static void _CleanLine(void) {
  GUI__memset(pabAABuffer,0, _x1 - _x0+1);
  _y = -16383;     
  _x0_InUse =  16383;
  _x1_InUse = -16383;
}
    ...
    if (Intens) {
      ...
      if (Intens == IMax) {
        ...
        if (j!=i) {
          ...
          GUI_Context . pLCD_HL->pfDrawPixel (_x0+i,_y);
        }
      } else {
...
static void _DrawHLine  (int x0, int y,  int x1) {
 ...
 
  {
    ...
    unsigned char *pDest = pabAABuffer+x0_Off;
    if (iRem ==1) {
      *(pDest) += x1-x0+1;
    } else {
...
int GUI_AA_Init(int x0, int x1) {
  ...
  DrawAPICopy = *GUI_Context.pLCD_HL;  
  pLCD_HLPrev = GUI_Context.pLCD_HL;  
  DrawAPICopy.pfDrawHLine = _DrawHLine;   
  GUI_Context.pLCD_HL = &DrawAPICopy;       
