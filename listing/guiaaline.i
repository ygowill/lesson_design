#line 1 "..\\code\\uCGUI\\AntiAlias\\GUIAALine.c"
...
#line 21 "..\\code\\uCGUI\\AntiAlias\\GUIAALine.c"
...
#line 22 "..\\code\\uCGUI\\AntiAlias\\GUIAALine.c"
...
static void _AA_DrawLine(int x0, int y0, int x1, int y1) {
  int xMin, xMax;
  unsigned char PenSizeOld = GUI_GetPenSize();
  unsigned char PenSizeHR  = PenSizeOld * GUI_Context.AA_Factor;
  unsigned char OldPenShape = GUI_SetPenShape((1));
...
void GUI_AA_DrawLine(int x0, int y0, int x1, int y1) {
  ;
    ...
    x0 += WM__GetOrgX_AA(); y0 += WM__GetOrgY_AA();
    x1 += WM__GetOrgX_AA(); y1 += WM__GetOrgY_AA();
