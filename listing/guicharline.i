#line 1 "..\\code\\uCGUI\\Core\\GUICharLine.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUICharLine.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUICharLine.c"
...
#line 23 "..\\code\\uCGUI\\Core\\GUICharLine.c"
...
int GUI__GetLineNumChars(const char  *s, int MaxNumChars) {
  ...
  if (s) {
    ...
    for (; NumChars < MaxNumChars; NumChars++) {
      unsigned short Data = GUI_UC__GetCharCodeInc(&s);
      if ((Data == 0) || (Data == '\n')) {
        break;
      }
    }
