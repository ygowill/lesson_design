#line 1 "..\\code\\uCGUI\\Core\\GUICharM.c"
...
#line 23 "..\\code\\uCGUI\\Core\\GUICharM.c"
...
#line 24 "..\\code\\uCGUI\\Core\\GUICharM.c"
...
void GUIMONO_DispChar(unsigned short c) {
  int c0, c1;
  ...
  if ((c >= (unsigned short)FirstChar) &&(c <= (unsigned short)pMono->LastChar)) {
    pd = pMono->pData;
    c0 = ((int)c) - FirstChar;
    c1 = -1;
  } else {
    ...
    if (pti) {
      ...
      if ((c >= (unsigned short)FirstChar) && (c <= (unsigned short)pti->LastChar)) {
  ...
  if (c0!=-1) {
    ...
    {
      unsigned char OldMode = LCD_SetDrawMode(DrawMode);
      LCD_DrawBitmap( x, y,
                         XSize, YSize,
...
int GUIMONO_GetCharDistX(unsigned short c) {
  const GUI_FONT_MONO  * pMono = GUI_Context.pAFont->p.pMono;
  c=c;;
...
char GUIMONO_IsInFont(const GUI_FONT  * pFont, unsigned short c) {
