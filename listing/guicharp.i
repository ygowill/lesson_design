#line 1 "..\\code\\uCGUI\\Core\\GUICharP.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUICharP.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUICharP.c"
...
static const GUI_FONT_PROP  * GUIPROP_FindChar(const GUI_FONT_PROP * pProp, unsigned short c) {
...
void GUIPROP_DispChar(unsigned short c) {
  int BytesPerLine;
...
int GUIPROP_GetCharDistX(unsigned short c) {
  const GUI_FONT_PROP  * pProp = GUIPROP_FindChar(GUI_Context.pAFont->p.pProp, c);
...
char GUIPROP_IsInFont(const GUI_FONT  * pFont, unsigned short c) {
