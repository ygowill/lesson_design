#line 1 "..\\code\\uCGUI\\Core\\GUICore.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUICore.c"
...
#line 376 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
  ...
  char               GUI_DecChar;
      ...
      void (*GUI_pfDispCharStyle)(unsigned short Char);


   const     tLCD_APIList *     GUI_pLCD_APIList;    



   GUI_CURSOR_tfTempHide*   GUI_CURSOR_pfTempHide;
   GUI_CURSOR_tfTempUnhide* GUI_CURSOR_pfTempUnhide;
...
#line 25 "..\\code\\uCGUI\\Core\\GUICore.c"
#line 26 "..\\code\\uCGUI\\Core\\GUICore.c"

#line 29 "..\\code\\uCGUI\\Core\\GUICore.c"
...
#line 155 "..\\code\\GUI\\GUI_inc\\GUI_ConfDefaults.h"
...
#line 384 "..\\code\\GUI\\GUI_inc\\GUIType.h"
...
#line 30 "..\\code\\uCGUI\\Core\\GUICore.c"
...
static void _InitContext(GUI_CONTEXT* pContext) {
  ...
  pContext->Color   = 0xFFFFFFF;
  pContext->BkColor = 0xFFFFFFF;
  LCD_SetBkColor(0x000000);
...
void GUI_ClearRect(int x0, int y0, int x1, int y1) {
  ...
  ;
  PrevDraw = LCD_SetDrawMode((1<<2));

    x0 += GUI_Context . xOff; y0 += GUI_Context . yOff;
    x1 += GUI_Context . xOff; y1 += GUI_Context . yOff;
    r.x0 = x0;
    r.x1 = x1;
    r.y0 = y0;
    r.y1 = y1;
...
void GUI_Clear(void) {
  GUI_GotoXY(0,0);      
  GUI_ClearRect(-4095, -4095, 4095, 4095);
}
...
int GUI_Init(void) {
  ...
  ;
#line 170 "..\\code\\uCGUI\\Core\\GUICore.c"
  return r;
}
