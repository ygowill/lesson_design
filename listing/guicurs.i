#line 1 "..\\code\\uCGUI\\Core\\GUICurs.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUICurs.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUICurs.c"
...
static signed short          _hBuffer;
static GUI_RECT          _Rect;
static char              _CursorIsVis;         
static char              _CursorOn;
static const GUI_CURSOR  * _pCursor;
static unsigned char                _CursorDeActCnt;
static int               _AllocSize;
static int               _x, _y;               
static GUI_RECT          _ClipRect;
static unsigned short    _ColorIndex[4];       
...
static void _Undraw(void) {
  ...
  ;
  if (_hBuffer) {
    pData = (unsigned short*)GUI_ALLOC_h2p(_hBuffer);
...
static char _TempHide(const GUI_RECT* pRect) {
  ...
  if ((pRect == 0) || GUI_RectsIntersect(pRect, &_Rect)) {
    _Hide();               
    return 1;
  }
  return 0;                
...
const GUI_CURSOR  * GUI_CURSOR_Select(const GUI_CURSOR  * pCursor) {
  ...
  if (pCursor != _pCursor) {
    ...
    _Hide();
    AllocSize = pBM->XSize * pBM->YSize * sizeof(unsigned short);
...
void GUI_CURSOR_Hide(void) {
  ...
  GUI_CURSOR_pfTempHide   = 0;
  GUI_CURSOR_pfTempUnhide = 0;
  ;
}
      ...
      if (_CursorOn) {
        ...
        for (y = yStart; y != yEnd; y += yStep) {
          ...
          for (x= xStart; x != xEnd; x += xStep) {
            ...
            unsigned short* pSave = pData + x + y * xSize;
            int xNew = x + xOff;
            BitmapPixel = GUI_GetBitmapPixelIndex(pBM, x, y);
            ...
            *pSave = Pixel;
            ...
            if (BitmapPixel) {
              unsigned short NewPixel = _Log2Phys(BitmapPixel);
...
#line 422 "..\\code\\uCGUI\\Core\\GUICurs.c"
