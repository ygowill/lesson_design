#line 1 "..\\code\\uCGUI\\Core\\GUIStream.c"
...
#line 21 "..\\code\\uCGUI\\Core\\GUIStream.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUIStream.c"
...
void GUI_DrawStreamedBitmap(const GUI_BITMAP_STREAM *pBitmapHeader, int x, int y) {
  ...
  Bitmap.pData        = ((const unsigned char*)pBitmapHeader)+16+4*pBitmapHeader->NumColors;
  Bitmap.pPal         = &Palette;
  ...
  Palette.pPalEntries = (const LCD_COLOR*)((const unsigned char*)pBitmapHeader+16);
