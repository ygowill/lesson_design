#line 1 "..\\code\\uCGUI\\Core\\GUITimer.c"
...
#line 22 "..\\code\\uCGUI\\Core\\GUITimer.c"
...
#line 23 "..\\code\\uCGUI\\Core\\GUITimer.c"
...
static void _Unlink(GUI_TIMER_HANDLE hTimer) {
  GUI_TIMER_Obj* pTimer = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hTimer);
  GUI_TIMER_HANDLE hi;
  GUI_TIMER_Obj*   pi;
  ...
  while(hi) {
    ...
    pi = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hi);
    if (pi->hNext == hTimer) {
...
static void _Link(GUI_TIMER_HANDLE hNew) {
  GUI_TIMER_Obj*   pNew        = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hNew);
  ...
  if (hFirstTimer ==0) {  
    ...
    GUI_TIMER_Obj* pFirstTimer      = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hFirstTimer);
    ...
    if ((pNew->t0 - pFirstTimer->t0) <=0) {
      ...
      do {
        pTimer       = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hTimer);
        hNext        = pTimer->hNext;
        if (hNext ==0)
					goto Append;
        pNext      = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hNext);
...
int GUI_TIMER_Exec(void) {
  ...
  ; {
    while (hFirstTimer) {
     	GUI_TIMER_Obj* pTimer = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hFirstTimer);
      if ((pTimer->t0-t) <=0) {
...
GUI_TIMER_HANDLE GUI_TIMER_Create(GUI_TIMER_CALLBACK* cb, int Time, unsigned long Context, int Flags) {
  ...
  GUI_pfTimerExec = GUI_TIMER_Exec;
    ...
    pObj = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hObj);
...
void GUI_TIMER_SetPeriod(GUI_TIMER_HANDLE hObj, int Period) {
  ; {
    GUI_TIMER_Obj* pObj = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hObj);
    pObj->Period = Period;
  } ; 
}
...
void GUI_TIMER_SetTime(GUI_TIMER_HANDLE hObj, int Time) {
  ; {
   	GUI_TIMER_Obj* pObj = (GUI_TIMER_Obj*)GUI_ALLOC_h2p(hObj);
    pObj->t0 = Time;
  } ; 
