#line 1 "..\\code\\uCGUI\\Widget\\HEADER.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\HEADER.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\HEADER.c"

#line 1 "..\\code\\uCGUI\\Widget\\HEADER_Private.h"
...
#line 25 "..\\code\\uCGUI\\Widget\\HEADER_Private.h"
...
#line 26 "..\\code\\uCGUI\\Widget\\HEADER_Private.h"
#line 27 "..\\code\\uCGUI\\Widget\\HEADER_Private.h"
...
#line 28 "..\\code\\uCGUI\\Widget\\HEADER_Private.h"
...
#line 51 "..\\code\\uCGUI\\Widget\\HEADER_Private.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\HEADER.c"
#line 25 "..\\code\\uCGUI\\Widget\\HEADER.c"
#line 26 "..\\code\\uCGUI\\Widget\\HEADER.c"
...
static GUI_COLOR          _DefaultBkColor   = 0xAAAAAA;
static GUI_COLOR          _DefaultTextColor = 0x000000;
static int                _DefaultBorderH   = 2;
static int                _DefaultBorderV   = 0;
...
#line 264 "..\\code\\uCGUI\\Widget\\HEADER.c"
...
static void _HEADER_Callback (WM_MESSAGE *pMsg) {
  ...
  ;
  pObj = (HEADER_Obj*) ((WM_Obj*)GUI_ALLOC_h2p(hObj));
  switch (pMsg->MsgId) {
    case 0x000F:
      _Paint( pObj);
      break;
    ...
    case 12:
      ...
      break;
#line 317 "..\\code\\uCGUI\\Widget\\HEADER.c"
    case 11:
      _FreeAttached(pObj);  
    default:
      WM_DefaultProc(pMsg);
...
HEADER_Handle HEADER_Create(int x0, int y0, int xsize, int ysize, GUI_HWIN hParent, int Id, int Flags, int ExFlags) {
                              ...
                              int WinFlags, int ExFlags, int Id)
{
  ...
  if (hObj) {
    HEADER_Obj* pObj = (HEADER_Obj*) ((WM_Obj*)GUI_ALLOC_h2p(hObj));
  ...
  if (hObj && (Width >= 0)) {
    ...
    if (Index <= GUI_ARRAY_GetNumItems(&pObj->Columns)) {
      ...
      if (pColumn) {
        pColumn->Width = Width;
        WM_InvalidateWindow(hObj);
        WM__SendMsgNoData(WM_GetParent(hObj), 37);
        WM_InvalidateWindow(WM_GetParent(hObj));
      }
    }
    ;
