#line 1 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
...
#line 20 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
...
#line 21 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
#line 1 "..\\code\\uCGUI\\JPEG\\jdct.h"
...
#line 150 "..\\code\\uCGUI\\JPEG\\jdct.h"
...
#line 22 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
...
#line 80 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
...
static void start_pass (j_decompress_ptr cinfo) {
  ...
  int method = 0;
  inverse_DCT_method_ptr method_ptr = 0;
  JQUANT_TBL * qtbl;

  for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components; ci++, compptr++) {
     
    switch (compptr->DCT_scaled_size) {
#line 113 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
    case 8:
	...
	method = JDCT_IFAST;
	break;
#line 133 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
      default:
	...
	for (i = 0; i < 64; i++) {
      ...
      break;
#line 231 "..\\code\\uCGUI\\JPEG\\jddctmgr.c"
    default:
      ((cinfo)->err->msg_code = (JERR_NOT_COMPILED), (*(cinfo)->err->error_exit) ((j_common_ptr) (cinfo)));
      break;
    }
