#line 1 "..\\code\\uCGUI\\JPEG\\jdmaster.c"
...
#line 16 "..\\code\\uCGUI\\JPEG\\jdmaster.c"
...
#line 17 "..\\code\\uCGUI\\JPEG\\jdmaster.c"
...
#line 161 "..\\code\\uCGUI\\JPEG\\jdmaster.c"
...
master_selection (j_decompress_ptr cinfo)
{
  ...
  master->quantizer_1pass = 0;
  master->quantizer_2pass = 0;
  ...
  if (cinfo->progress != 0 && ! cinfo->buffered_image &&
...
prepare_for_output_pass (j_decompress_ptr cinfo)
{
  ...
  if (master->pub.is_dummy_pass) {
    ...
    if (cinfo->quantize_colors && cinfo->colormap == 0) {
