#line 1 "..\\code\\uCGUI\\JPEG\\jmemmgr.c"
...
#line 30 "..\\code\\uCGUI\\JPEG\\jmemmgr.c"
...
#line 31 "..\\code\\uCGUI\\JPEG\\jmemmgr.c"
...
#line 32 "..\\code\\uCGUI\\JPEG\\jmemmgr.c"
...
#line 207 "..\\code\\uCGUI\\JPEG\\jmemmgr.c"
...
static void * alloc_large (j_common_ptr cinfo, int pool_id, size_t sizeofobject)   {
  ...
  hdr_ptr = (large_pool_ptr) jpeg_get_small  (cinfo, sizeofobject +  ((size_t) sizeof(large_pool_hdr)));
  if (hdr_ptr == 0) {
...
static void realize_virt_arrays (j_common_ptr cinfo) {
  ...
  maximum_space = 0;
  for (sptr = mem->virt_sarray_list; sptr != 0; sptr = sptr->next) {
    if (sptr->mem_buffer == 0) {  
  ...
  for (bptr = mem->virt_barray_list; bptr != 0; bptr = bptr->next) {
    if (bptr->mem_buffer == 0) {  
...
#line 649 "..\\code\\uCGUI\\JPEG\\jmemmgr.c"
...
free_pool (j_common_ptr cinfo, int pool_id)
{
  ...
  if (pool_id == 1) {
    ...
    mem->virt_barray_list = 0;
  }

   
  lhdr_ptr = mem->large_list[pool_id];
  mem->large_list[pool_id] = 0;
  ...
  while (lhdr_ptr != 0) {
    ...
    jpeg_free_small (cinfo, (void  *) lhdr_ptr, space_freed);
...
jinit_memory_mgr (j_common_ptr cinfo)
{
  ...
  for (pool = 2-1; pool >= 0; pool--) {
    mem->small_list[pool] = 0;
    mem->large_list[pool] = 0;
  }
  mem->virt_sarray_list = 0;
  mem->virt_barray_list = 0;
...
#line 1070 "..\\code\\uCGUI\\JPEG\\jmemmgr.c"
