...
#line 24 "..\\code\\uCGUI\\Core\\LCD.c"
#line 1 "..\\code\\uCGUI\\Core\\GUI_Private.h"
...
#line 1 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
...
#line 24 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
#line 1 "..\\code\\uCGUI\\Core\\LCD_Protected.h"
...
#line 24 "..\\code\\uCGUI\\Core\\LCD_Protected.h"
...
#line 25 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
#line 1 "..\\code\\uCGUI\\Core\\GUIDebug.h"
...
#line 27 "..\\code\\uCGUI\\Core\\GUIDebug.h"
#line 1 "..\\code\\uCGUI\\Core\\GUI_X.h"
...
#line 28 "..\\code\\uCGUI\\Core\\GUI_X.h"
...
#line 28 "..\\code\\uCGUI\\Core\\GUIDebug.h"

#line 35 "..\\code\\uCGUI\\Core\\GUIDebug.h"

#line 44 "..\\code\\uCGUI\\Core\\GUIDebug.h"
...
#line 90 "..\\code\\uCGUI\\Core\\GUIDebug.h"
...
#line 123 "..\\code\\uCGUI\\Core\\GUIDebug.h"
...
#line 155 "..\\code\\uCGUI\\Core\\GUIDebug.h"
...
#line 26 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
...
#line 28 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
...
#line 113 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
...
#line 201 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
...
#line 216 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
...
#line 376 "..\\code\\uCGUI\\Core\\GUI_Protected.h"
...
#line 28 "..\\code\\uCGUI\\Core\\GUI_Private.h"
#line 1 "..\\code\\uCGUI\\Core\\LCD_Private.h"
...
#line 1 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 24 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
#line 25 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 112 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"

#line 119 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 182 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"

#line 189 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 245 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"

 
#line 271 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"

#line 283 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 308 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"

#line 328 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"





#line 339 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 442 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 539 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 636 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 733 "..\\code\\uCGUI\\Core\\LCD_ConfDefaults.h"
...
#line 24 "..\\code\\uCGUI\\Core\\LCD_Private.h"
#line 25 "..\\code\\uCGUI\\Core\\LCD_Private.h"
#line 26 "..\\code\\uCGUI\\Core\\LCD_Private.h"
...
#line 59 "..\\code\\uCGUI\\Core\\LCD_Private.h"
...
#line 77 "..\\code\\uCGUI\\Core\\LCD_Private.h"
...
#line 105 "..\\code\\uCGUI\\Core\\LCD_Private.h"

#line 113 "..\\code\\uCGUI\\Core\\LCD_Private.h"
...
#line 29 "..\\code\\uCGUI\\Core\\GUI_Private.h"

#line 57 "..\\code\\uCGUI\\Core\\GUI_Private.h"
...
#line 25 "..\\code\\uCGUI\\Core\\LCD.c"
#line 26 "..\\code\\uCGUI\\Core\\LCD.c"
#line 27 "..\\code\\uCGUI\\Core\\LCD.c"
...
static int _GetColorIndex(int i)    {
  return  (GUI_Context.DrawMode & (1<<2)) ? i-1 : i;
}
...
void LCD_SetColorIndex(int Index) {
  GUI_Context . LCD . aColorIndex16[_GetColorIndex(1)] = Index;
}
...
void LCD_SetBkColorIndex(int Index) {
  GUI_Context . LCD . aColorIndex16[_GetColorIndex(0)] = Index;
}
...
LCD_DRAWMODE LCD_SetDrawMode(LCD_DRAWMODE dm) {
  ...
  if ((GUI_Context.DrawMode^dm) & (1<<2)) {
    unsigned short temp = GUI_Context . LCD . aColorIndex16[0];
    GUI_Context . LCD . aColorIndex16[0]    = GUI_Context . LCD . aColorIndex16[1];
    GUI_Context . LCD . aColorIndex16[1] = temp;
  }
...
void LCD_DrawPixel(int x, int y) {
  if (y < GUI_Context . ClipRect . y0) return; if (y > GUI_Context . ClipRect . y1) return;;
  if (x < GUI_Context . ClipRect . x0) return; if (x > GUI_Context . ClipRect . x1) return;;
  if (GUI_Context.DrawMode & (1<<0)) {
    LCD_L0_XorPixel(x, y);
  } else {
    LCD_L0_SetPixelIndex(x, y, GUI_Context . LCD . aColorIndex16[1]);
  }
}
...
void LCD_DrawHLine(int x0, int y,  int x1) {
  ...
  if (y < GUI_Context . ClipRect . y0) return; if (y > GUI_Context . ClipRect . y1) return;;
  if (x0 < GUI_Context . ClipRect . x0) { x0 = GUI_Context . ClipRect . x0; } if (x1 > GUI_Context . ClipRect . x1) { x1 = GUI_Context . ClipRect . x1; };
  if (x1<x0)
    return;
...
void LCD_FillRect(int x0, int y0, int x1, int y1) {
  ...
  if (x1<x0)
    return;
  if (y0 < GUI_Context . ClipRect . y0) { y0 = GUI_Context . ClipRect . y0; } if (y1 > GUI_Context . ClipRect . y1) { y1 = GUI_Context . ClipRect . y1; };
  if (y1<y0)
    return;
...
void LCD_DrawBitmap(int x0, int y0, int xsize, int ysize, int xMul, int yMul,
                       int BitsPerPixel, int BytesPerLine,
                       const unsigned char  * pPixel, const unsigned short* pTrans)
{
    ...
    for (y=y0, yi=0; yi<ysize; yi++, y+= yMul, pPixel+=BytesPerLine) {
      ...
      if ((yMax >= GUI_Context.ClipRect.y0) && (y <= GUI_Context.ClipRect.y1)) {
        ...
        for (x=x0, xi=0; xi<xsize; xi++, x+=xMul) {
          ...
          if (Index || ((GUI_Context.DrawMode & (1<<1)) ==0)) {
            unsigned short  OldColor = GUI_Context . LCD . aColorIndex16[1];
            if (pTrans) {
              GUI_Context . LCD . aColorIndex16[1] = *(pTrans+Index);
            } else {
              GUI_Context . LCD . aColorIndex16[1] = Index;
            }
            LCD_FillRect(x,y, x+xMul-1, yMax);
            GUI_Context . LCD . aColorIndex16[1] = OldColor;
          }
        }
      }
    }
...
int LCD_Init(void) {
  ...
  LCD_SetClipRectMax();
  r |= LCD_L0_Init();
#line 289 "..\\code\\uCGUI\\Core\\LCD.c"
  LCD_InitLUT();
  {
