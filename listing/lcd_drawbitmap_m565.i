#line 1 "..\\code\\uCGUI\\Core\\LCD_DrawBitmap_M565.c"
...
#line 21 "..\\code\\uCGUI\\Core\\LCD_DrawBitmap_M565.c"
...
#line 22 "..\\code\\uCGUI\\Core\\LCD_DrawBitmap_M565.c"
#line 23 "..\\code\\uCGUI\\Core\\LCD_DrawBitmap_M565.c"
...
static void _DrawBitmap_M565(int x0,int y0,int xsize, int ysize, const unsigned char  * pPixel, const LCD_LOGPALETTE  * pLogPal, int xMag, int yMag) {
...
#line 57 "..\\code\\uCGUI\\Core\\LCD_DrawBitmap_M565.c"
  if (UseDrawBitmap) {
    ...
    if (Mag == 1) {
      ...
      for (y = 0; y < ysize; y++) {
        ...
        for (x = 0; x < xsize; x++) {
          ...
          LCD_L0_SetPixelIndex(x + x0, y + y0, GUI_Context . LCD . aColorIndex16[1]);
        }
