#line 1 "..\\code\\uCGUI\\Core\\LCD_RotateCCW.c"
...
#line 21 "..\\code\\uCGUI\\Core\\LCD_RotateCCW.c"
#line 22 "..\\code\\uCGUI\\Core\\LCD_RotateCCW.c"
...
#line 24 "..\\code\\uCGUI\\Core\\LCD_RotateCCW.c"
...
static void  _DrawBitLine1BPP(int x, int y, unsigned char const  *p, int Diff, int xsize, const unsigned short*pTrans) {
  ...
  case (1<<0):;
    do {
        ...
        LCD_L0_SetPixelIndex(x, y, (1L<<(16)) - 1 - Pixel);
      }
      y--;
			if (++Diff == 8) {
        Diff = 0;
