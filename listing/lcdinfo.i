#line 1 "..\\code\\uCGUI\\Core\\LCDInfo.c"
...
#line 21 "..\\code\\uCGUI\\Core\\LCDInfo.c"
...
#line 22 "..\\code\\uCGUI\\Core\\LCDInfo.c"
...
#line 23 "..\\code\\uCGUI\\Core\\LCDInfo.c"
...
signed long LCD_GetDevCap(int Index) {
  ...
  if ((Index >= 0x1000) && (Index < 0x1000+(1L<<(16)))) {
    return LCD_Index2Color(Index-0x1000);
  }
  return 0;
}
