#line 1 "..\\code\\uCGUI\\ConvertMono\\LCDP0.c"
...
#line 21 "..\\code\\uCGUI\\ConvertMono\\LCDP0.c"
#line 22 "..\\code\\uCGUI\\ConvertMono\\LCDP0.c"
...
unsigned LCD_Color2Index_0(LCD_COLOR Color, const LCD_PHYSPALETTE* pPhysPal) {
  ...
  int BestIndex = 0;
  unsigned long BestDiff = 0xffffff;  
  ...
  i=0; pPalEntry = &pPhysPal->pPalEntries[0];
  do {
    unsigned long Diff = GUI_CalcColorDist (Color, *(pPalEntry+i));
    if (Diff < BestDiff) {
      BestDiff  = Diff;
      BestIndex = i;
    }
