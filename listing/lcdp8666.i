#line 1 "..\\code\\uCGUI\\ConvertColor\\LCDP8666.c"
...
#line 21 "..\\code\\uCGUI\\ConvertColor\\LCDP8666.c"
...
#line 46 "..\\code\\uCGUI\\ConvertColor\\LCDP8666.c"
...
LCD_COLOR LCD_Index2Color_8666(int Index) {
  ...
  if ((Index>=120) && (Index<136)) {
    return (unsigned long)0x111111 * (unsigned long)(Index-120);
	}
  if (Index>=108) {
    if (Index<148)
			return 0;   
