#line 1 "..\\code\\uCGUI\\Widget\\LISTBOX_Create.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\LISTBOX_Create.c"
...
LISTBOX_Handle LISTBOX_Create(const GUI_ConstString* ppText, int x0, int y0, int xsize, int ysize, int Flags) {
  return LISTBOX_CreateEx(x0, y0, xsize, ysize, (0), Flags, 0, 0, ppText);
}
...
LISTBOX_Handle LISTBOX_CreateAsChild(const GUI_ConstString* ppText, GUI_HWIN hWinParent,
