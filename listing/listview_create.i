#line 1 "..\\code\\uCGUI\\Widget\\LISTVIEW_Create.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\LISTVIEW_Create.c"
...
LISTVIEW_Handle LISTVIEW_Create(int x0, int y0, int xsize, int ysize, GUI_HWIN hParent, int Id, int Flags, int ExFlags) {
...
LISTVIEW_Handle LISTVIEW_CreateAttached(GUI_HWIN hParent, int Id, int SpecialFlags) {
  return LISTVIEW_CreateEx(0, 0, 0, 0, hParent, (1<<1), SpecialFlags, Id);
}
