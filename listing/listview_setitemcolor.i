#line 1 "..\\code\\uCGUI\\Widget\\LISTVIEW_SetItemColor.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\LISTVIEW_SetItemColor.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\LISTVIEW_SetItemColor.c"
...
static LISTVIEW_ITEM_INFO * _GetpItemInfo(LISTVIEW_Handle hObj, unsigned Column, unsigned Row, unsigned int Index) {
  ...
  LISTVIEW_Obj       * pObj;
  if (hObj) {
    if ((Column < LISTVIEW_GetNumColumns(hObj)) && (Row < LISTVIEW_GetNumRows(hObj)) && (Index < (sizeof(pItemInfo->aTextColor) / sizeof(pItemInfo->aTextColor[0])))) {
      ...
      if (!pItem->hItemInfo) {
        ...
        for (i = 0; i < (sizeof(pItemInfo->aTextColor) / sizeof(pItemInfo->aTextColor[0])); i++) {
