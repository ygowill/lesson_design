#line 1 "..\\code\\uCGUI\\Widget\\MENU_Default.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MENU_Default.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MENU_Default.c"
...
void MENU_SetDefaultTextColor(unsigned ColorIndex, GUI_COLOR Color) {
  if (ColorIndex <= (sizeof(MENU__DefaultProps . aTextColor) / sizeof(MENU__DefaultProps . aTextColor[0]))) {
...
void MENU_SetDefaultBkColor(unsigned ColorIndex, GUI_COLOR Color) {
  if (ColorIndex <= (sizeof(MENU__DefaultProps . aBkColor) / sizeof(MENU__DefaultProps . aBkColor[0]))) {
...
void MENU_SetDefaultBorderSize(unsigned BorderIndex, unsigned char BorderSize) {
  if (BorderIndex <= (sizeof(MENU__DefaultProps . aBorder) / sizeof(MENU__DefaultProps . aBorder[0]))) {
