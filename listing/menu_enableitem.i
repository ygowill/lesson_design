#line 1 "..\\code\\uCGUI\\Widget\\MENU_EnableItem.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MENU_EnableItem.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MENU_EnableItem.c"
...
void MENU_EnableItem(MENU_Handle hObj, unsigned short ItemId) {
  if (hObj) {
    ...
    if (Index >= 0) {
      ...
      MENU__SetItemFlags(pObj, Index, (1<<0), 0);
