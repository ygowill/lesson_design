#line 1 "..\\code\\uCGUI\\Widget\\MENU_Popup.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MENU_Popup.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MENU_Popup.c"
...
void MENU_Popup(MENU_Handle hObj, GUI_HWIN hDestWin, int x, int y, int xSize, int ySize, int Flags) {
  ...
  if (hObj && hDestWin) {
    ...
    if (pObj) {
      ...
      MENU__SendMenuMessage(hDestWin, hObj, 3, 0);
    }
    ;
  }
}
