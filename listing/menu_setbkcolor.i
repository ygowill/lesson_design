#line 1 "..\\code\\uCGUI\\Widget\\MENU_SetBkColor.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MENU_SetBkColor.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MENU_SetBkColor.c"
...
void MENU_SetBkColor(MENU_Handle hObj, unsigned ColorIndex, GUI_COLOR Color) {
  if (hObj) {
    ...
    if (pObj) {
      if (ColorIndex < (sizeof(pObj->Props . aBkColor) / sizeof(pObj->Props . aBkColor[0]))) {
