#line 1 "..\\code\\uCGUI\\Widget\\MENU_SetBorderSize.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MENU_SetBorderSize.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MENU_SetBorderSize.c"
...
void MENU_SetBorderSize(MENU_Handle hObj, unsigned BorderIndex, unsigned char BorderSize) {
  if (hObj) {
    ...
    if (pObj) {
      if (BorderIndex < (sizeof(pObj->Props . aBorder) / sizeof(pObj->Props . aBorder[0]))) {
