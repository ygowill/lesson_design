#line 1 "..\\code\\uCGUI\\Widget\\MENU_SetTextColor.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MENU_SetTextColor.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MENU_SetTextColor.c"
...
void MENU_SetTextColor(MENU_Handle hObj, unsigned ColorIndex, GUI_COLOR Color) {
  if (hObj) {
    ...
    if (pObj) {
      if (ColorIndex < (sizeof(pObj->Props . aTextColor) / sizeof(pObj->Props . aTextColor[0]))) {
