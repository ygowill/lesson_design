#line 1 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
...
#line 25 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
...
#line 26 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
...
#line 27 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
#line 1 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.h"
...
#line 28 "..\\code\\uCGUI\\Widget\\MESSAGEBOX.c"
...
GUI_HWIN MESSAGEBOX_Create(const char * sMessage, const char * sCaption, int Flags) {
  ...
  int BorderSize = FRAMEWIN_GetDefaultBorderSize();                              
  int xSizeFrame = 50 + 2 * BorderSize + 4 * 2;  
  int ySizeFrame;                                                                
  int x0, y0;                                                                    
  int xSizeMessage;                                                              
  int xSizeCaption;                                                              
  ...
  xSizeMessage = Rect.x1 - Rect.x0 + 4 * 2;
  ySizeMessage = Rect.y1 - Rect.y0 + 1;
  if (xSizeFrame < (xSizeMessage + 4 + 4 * 2)) {
    xSizeFrame = xSizeMessage + 4 + 4 * 2;
  }
  ySizeCaption = GUI_GetYSizeOfFont(FRAMEWIN_GetDefaultFont());
  ySizeFrame = ySizeMessage +             
               20 +       
               ySizeCaption +             
               4 * 3 +    
               BorderSize * 2 +           
  ...
  _aDialogCreate[1].y0               = 4;
  _aDialogCreate[1].xSize            = xSizeMessage;
  _aDialogCreate[1].ySize            = ySizeMessage;
  _aDialogCreate[1].Para             = (0<<2) | (2<<0);
   
  _aDialogCreate[2].pfCreateIndirect = BUTTON_CreateIndirect;
  _aDialogCreate[2].pName            = "OK";
  _aDialogCreate[2].Id               = 1;
  _aDialogCreate[2].x0               = (xSizeFrame - 50 - BorderSize * 2) / 2;
  _aDialogCreate[2].y0               = 4 * 2 + ySizeMessage;
  _aDialogCreate[2].xSize            = 50;
  _aDialogCreate[2].ySize            = 20;
   
  return GUI_CreateDialogBox(_aDialogCreate, (sizeof(_aDialogCreate) / sizeof(_aDialogCreate[0])), _MESSAGEBOX_cbCallback, 0, 0, 0);
}
