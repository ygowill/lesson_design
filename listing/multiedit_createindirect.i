#line 1 "..\\code\\uCGUI\\Widget\\MULTIEDIT_CreateIndirect.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MULTIEDIT_CreateIndirect.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MULTIEDIT_CreateIndirect.c"
...
MULTIEDIT_HANDLE MULTIEDIT_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, GUI_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
  ...
  hThis = MULTIEDIT_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
                             hWinParent, 0, pCreateInfo->Flags, pCreateInfo->Id, pCreateInfo->Para, 0);
  return hThis;
}
