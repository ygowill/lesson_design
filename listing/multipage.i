#line 1 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
#line 1 "..\\code\\uCGUI\\Widget\\MULTIPAGE_Private.h"
...
#line 23 "..\\code\\uCGUI\\Widget\\MULTIPAGE_Private.h"
#line 1 "..\\code\\uCGUI\\Widget\\MULTIPAGE.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\MULTIPAGE.h"
...
#line 25 "..\\code\\uCGUI\\Widget\\MULTIPAGE.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\MULTIPAGE_Private.h"
...
#line 48 "..\\code\\uCGUI\\Widget\\MULTIPAGE_Private.h"
...
#line 25 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
#line 26 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
...
const GUI_FONT  * MULTIPAGE__pDefaultFont        = &GUI_Font13_1;
unsigned                     MULTIPAGE__DefaultAlign        = ((0<<0) | (0<<2));
GUI_COLOR                    MULTIPAGE__DefaultBkColor[2]   = { 0xD0D0D0, 0xC0C0C0 };
GUI_COLOR                    MULTIPAGE__DefaultTextColor[2] = { 0x808080, 0x000000 };
...
static void _ShowPage(MULTIPAGE_Obj* pObj, unsigned Index) {
  ...
  GUI_HWIN hChild;
  WM_Obj* pChild;
  WM_Obj* pClient = ((WM_Obj*)GUI_ALLOC_h2p(pObj->hClient));
...
static void _UpdatePositions(MULTIPAGE_Handle hObj, MULTIPAGE_Obj* pObj) {
  ...
  if (Width > rBorder.x1) {
    ...
    x0     = (pObj->Align & (1<<0))  ? (rBorder.x0) : (rBorder.x1 - 2*Size + 1);
    y0     = (pObj->Align & (1<<2)) ? (rBorder.y1) : (rBorder.y0 -   Size + 1);
     
    _AddScrollbar(hObj, pObj, x0, y0, 2 * Size, Size);
    _GetTextRect(pObj, &rText);
    while (Width >= (((rText . x1 - rText . x0 + 1) > 1) ? (rText . x1 - rText . x0 + 1) : 1)) {
...
static void _Paint(MULTIPAGE_Obj* pObj) {
  ...
  if (pObj->Handles.NumItems > 0) {
    ...
    for (i = 0; i < pObj->Handles.NumItems; i++) {
      ...
      _DrawTextItem(pObj, &pPage->acText, i, &rText, x0, w, (pPage->Status & (1<<0)) ? 1 : 0);
    }    
    ...
    if (pState->Pressed) {
      ...
      if (!_ClickedOnMultipage(hObj, pObj, x, y)) {
        ...
        if (hBelow) {
          ...
          pMsg->hWin = hBelow;
          (*((WM_Obj*)GUI_ALLOC_h2p(hBelow))->cb)(pMsg);
        }
      } else {
        WM_BringToTop(hObj);
      }
...
static void _Callback (WM_MESSAGE *pMsg) {
  ...
  int Handled;
  ;
  pObj    = (MULTIPAGE_Obj*) ((WM_Obj*)GUI_ALLOC_h2p(hObj));
...
static void _ClientCallback(WM_MESSAGE* pMsg) {
  GUI_HWIN hObj = pMsg->hWin;
  GUI_HWIN hParent = WM_GetParent(hObj);
  MULTIPAGE_Obj* pParent;
  ;
  pParent = (MULTIPAGE_Obj*) ((WM_Obj*)GUI_ALLOC_h2p(hParent));
  switch (pMsg->MsgId) {
  case 0x000F:
                                    ...
                                    int WinFlags, int ExFlags, int Id)
{
  ...
  hObj = WM_CreateWindowAsChild(x0, y0, xsize, ysize, hParent, WinFlags | (1<<0), &_Callback,
...
#line 973 "..\\code\\uCGUI\\Widget\\MULTIPAGE.c"
