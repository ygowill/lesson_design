#line 1 "..\\code\\uCGUI\\Widget\\MULTIPAGE_Default.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\MULTIPAGE_Default.c"
...
GUI_COLOR MULTIPAGE_GetDefaultBkColor(unsigned Index) {
  GUI_COLOR Color = 0xFFFFFFF;
  if (Index < (sizeof(MULTIPAGE__DefaultBkColor) / sizeof(MULTIPAGE__DefaultBkColor[0]))) {
...
GUI_COLOR MULTIPAGE_GetDefaultTextColor(unsigned Index) {
  GUI_COLOR Color = 0xFFFFFFF;
  if (Index < (sizeof(MULTIPAGE__DefaultTextColor) / sizeof(MULTIPAGE__DefaultTextColor[0]))) {
