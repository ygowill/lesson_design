#line 1 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
...
#line 26 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
...
#line 185 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        *perr = 1u;
        return (pevent);
    }
...
#line 305 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        *perr = 1u;
        return ((void *)0);
    }
...
#line 417 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        *perr = 1u;
        return (0u);
    }
...
#line 490 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 563 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {   
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 631 "..\\code\\UCOSII\\SOURCE\\os_mbox.c"
    if (pevent->OSEventType != 1u) {        
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
