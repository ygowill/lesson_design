#line 1 "..\\code\\UCOSII\\SOURCE\\os_sem.c"
...
#line 26 "..\\code\\UCOSII\\SOURCE\\os_sem.c"
...
#line 193 "..\\code\\UCOSII\\SOURCE\\os_sem.c"
    if (pevent->OSEventType != 3u) {         
        *perr = 1u;
        return (pevent);
    }
...
#line 311 "..\\code\\UCOSII\\SOURCE\\os_sem.c"
    if (pevent->OSEventType != 3u) {    
        *perr = 1u;
        return;
    }
...
#line 420 "..\\code\\UCOSII\\SOURCE\\os_sem.c"
    if (pevent->OSEventType != 3u) {    
        *perr = 1u;
        return (0u);
    }
...
#line 545 "..\\code\\UCOSII\\SOURCE\\os_sem.c"
    if (pevent->OSEventType != 3u) {         
        return (1u);
    }
    {cpu_sr = OS_CPU_SR_Save();};
...
#line 609 "..\\code\\UCOSII\\SOURCE\\os_sem.c"
    if (pevent->OSEventType != 3u) {    
        *perr = 1u;
        return;
    }
