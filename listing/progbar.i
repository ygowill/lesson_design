#line 1 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
#line 1 "..\\code\\uCGUI\\Widget\\PROGBAR.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\PROGBAR.h"
...
#line 25 "..\\code\\uCGUI\\Widget\\PROGBAR.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
...
#line 25 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
...
#line 95 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
...
#line 118 "..\\code\\uCGUI\\Widget\\PROGBAR.c"
...
static void _FreeText(PROGBAR_Handle hObj) {
  PROGBAR_Obj* pObj = (PROGBAR_Obj*) GUI_ALLOC_h2p(hObj);
...
static int _Value2X(const PROGBAR_Obj* pObj, int v) {
  ...
  return EffectSize + ((xSize - 2 * EffectSize) * (signed long)(v - Min)) / (Max - Min);
}
...
static const char* _GetText(const PROGBAR_Obj* pObj, char* pBuffer) {
  ...
  if (pObj->hpText) {
    ...
    pText = pBuffer;
    GUI_AddDecMin((100 * (signed long)(pObj->v - pObj->Min)) / (pObj->Max - pObj->Min), &pBuffer);
    *pBuffer++ = '%';
		*pBuffer   = 0;
	}
                                ...
                                int WinFlags, int ExFlags, int Id)
{
  ...
  if (hObj) {
    ...
    WIDGET_SetEffect(hObj, &WIDGET_Effect_None);  
    ;
     
    pObj->pFont        = &GUI_Font8x16;
...
void PROGBAR_SetBarColor(PROGBAR_Handle hObj, unsigned int Index, GUI_COLOR color) {
  ...
  if (hObj) {
    ;
    pObj = (PROGBAR_Obj*) GUI_ALLOC_h2p(hObj);
    if (Index < (sizeof(pObj->BarColor) / sizeof(pObj->BarColor[0]))) {
...
void PROGBAR_SetTextColor(PROGBAR_Handle hObj, unsigned int Index, GUI_COLOR color) {
  ...
  if (hObj) {
    ;
    pObj = (PROGBAR_Obj*) GUI_ALLOC_h2p(hObj);
    if (Index < (sizeof(pObj->TextColor) / sizeof(pObj->TextColor[0]))) {
