#line 1 "..\\code\\uCGUI\\Widget\\RADIO_SetGroupId.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\RADIO_SetGroupId.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\RADIO_SetGroupId.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\RADIO_SetGroupId.c"
...
static int _IsInGroup(GUI_HWIN hWin, unsigned char GroupId) {
  if (GroupId) {
    WM_MESSAGE Msg;
    Msg.MsgId = 43;
...
static GUI_HWIN _GetPrevInGroup(GUI_HWIN hWin, unsigned char GroupId) {
...
static GUI_HWIN _GetNextInGroup(GUI_HWIN hWin, unsigned char GroupId) {
...
static void _ClearSelection(RADIO_Handle hObj, unsigned char GroupId) {
  GUI_HWIN hWin;
  WM_Obj* pWin;
...
static void _HandleSetValue(RADIO_Handle hObj, RADIO_Obj* pObj, int v) {
  if (v < 0) {
    GUI_HWIN hWin = _GetPrevInGroup(hObj, pObj->GroupId);
    if (hWin) {
      WM_SetFocus(hWin);
    ...
    GUI_HWIN hWin = _GetNextInGroup(pObj->Widget.Win.hNext, pObj->GroupId);
    if (hWin) {
      WM_SetFocus(hWin);
      _SetValue(hWin, 0);
      RADIO__SetValue(hObj, pObj, -1);
...
void RADIO_SetGroupId(RADIO_Handle hObj, unsigned char NewGroupId) {
  if (hObj) {
    RADIO_Obj* pObj;
    unsigned char OldGroupId;
    ;
    pObj = (RADIO_Obj*) GUI_ALLOC_h2p(hObj);
    ...
    if (NewGroupId != OldGroupId) {
      ...
      if (NewGroupId && (RADIO__pfHandleSetValue == 0)) {
