#line 1 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
#line 1 "..\\code\\uCGUI\\Widget\\SCROLLBAR_Private.h"
...
#line 24 "..\\code\\uCGUI\\Widget\\SCROLLBAR_Private.h"
#line 25 "..\\code\\uCGUI\\Widget\\SCROLLBAR_Private.h"
#line 26 "..\\code\\uCGUI\\Widget\\SCROLLBAR_Private.h"
...
#line 49 "..\\code\\uCGUI\\Widget\\SCROLLBAR_Private.h"
...
extern signed short        SCROLLBAR__DefaultWidth;
...
#line 24 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
#line 25 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
#line 26 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
...
GUI_COLOR SCROLLBAR__aDefaultBkColor[2] = {0x808080, 0x000000};
GUI_COLOR SCROLLBAR__aDefaultColor[2]   = {0xc0c0c0, 0x000000};
signed short       SCROLLBAR__DefaultWidth       =  11;
...
static void _CalcPositions(SCROLLBAR_Obj* pObj, SCROLLBAR_POSITIONS* pPos) {
  ...
  x0 = r.x0;
  y0 = r.y0;
  pPos->x1  = (pObj->Widget.State & (1<<3)) ? r.y1 : r.x1;
   
  if (pObj->Widget.Id == 0xFF) {
...
static void _ScrollbarPressed(SCROLLBAR_Handle hObj, SCROLLBAR_Obj* pObj) {
  WIDGET_OrState(hObj, (1<<8));
  if (pObj->Widget.Win.Status & (1<<1)) {
...
void SCROLLBAR__InvalidatePartner(SCROLLBAR_Handle hObj) {      
  ...
  WM_SendMessageNoPara(WM_GetParent(hObj), 37);    
}
...
static void _SCROLLBAR_Callback (WM_MESSAGE *pMsg) {
  ...
  SCROLLBAR_Obj* pObj;
  hObj = pMsg->hWin;
  pObj = (SCROLLBAR_Obj*) GUI_ALLOC_h2p(hObj);
...
#line 614 "..\\code\\uCGUI\\Widget\\SCROLLBAR.c"
