#line 1 "..\\code\\uCGUI\\Widget\\SCROLLBAR_Defaults.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\SCROLLBAR_Defaults.c"
...
GUI_COLOR SCROLLBAR_GetDefaultBkColor(unsigned int Index) {
  if (Index < (sizeof(SCROLLBAR__aDefaultBkColor) / sizeof(SCROLLBAR__aDefaultBkColor[0]))) {
...
GUI_COLOR SCROLLBAR_GetDefaultColor(unsigned int Index) {
  if (Index < (sizeof(SCROLLBAR__aDefaultColor) / sizeof(SCROLLBAR__aDefaultColor[0]))) {
