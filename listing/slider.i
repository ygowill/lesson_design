#line 1 "..\\code\\uCGUI\\Widget\\SLIDER.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\SLIDER.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\SLIDER.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\SLIDER.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\SLIDER.c"
#line 25 "..\\code\\uCGUI\\Widget\\SLIDER.c"
...
#line 101 "..\\code\\uCGUI\\Widget\\SLIDER.c"
...
static GUI_COLOR _DefaultBkColor = 0xc0c0c0;
...
static void _Paint(SLIDER_Obj* pObj, GUI_HWIN hObj) {
...
#line 143 "..\\code\\uCGUI\\Widget\\SLIDER.c"
  ...
  rSlider    = r;
  rSlider.y0 = 5;
  rSlider.x0 = x0 + (unsigned long)xsize * (unsigned long)(pObj->v - pObj->Min) / Range - pObj->Width / 2;
  ...
  rSlot.y1 = rSlot.y0 + 3;
  WIDGET__EFFECT_DrawDownRect(&pObj->Widget, &rSlot);         
...
static void _OnTouch(SLIDER_Handle hObj, SLIDER_Obj* pObj, WM_MESSAGE*pMsg) {
  ...
  if (pMsg->Data.p) {   
    if (pState->Pressed) {
      ...
      Range = (pObj->Max - pObj->Min);
      x0    = 1 + pObj->Width / 2;   
      x     = (pObj->Widget.State & (1<<3)) ? pState->y : pState->x;
      x    -= x0;
      ...
      if (x <= 0) {
        ...
        int Div;
        Div = xsize ? xsize : 1;      
        Sel = pObj->Min + ((unsigned long)Range * (unsigned long)x + Div / 2) / Div;
      }
...
static void _SLIDER_Callback (WM_MESSAGE *pMsg) {
  ...
  SLIDER_Obj* pObj;
  hObj = pMsg->hWin;
  pObj = (SLIDER_Obj*) GUI_ALLOC_h2p(hObj);
                              ...
                              int WinFlags, int ExFlags, int Id)
{
  ...
  if (hObj) {
    SLIDER_Obj* pObj = (SLIDER_Obj*) GUI_ALLOC_h2p(hObj);
    ...
    pObj->aBkColor[1] = 0xFFFFFF;
    pObj->aColor[0]   = 0xc0c0c0;
    pObj->aColor[1]   = 0x000000;
    pObj->Width       = 8;
    pObj->Max         = 100;
    pObj->Min         = 0;
    pObj->NumTicks    = -1;
...
#line 532 "..\\code\\uCGUI\\Widget\\SLIDER.c"
