#line 1 "..\\code\\uCGUI\\Widget\\TEXT_CreateIndirect.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\TEXT_CreateIndirect.c"
...
TEXT_Handle TEXT_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, GUI_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
  ...
  hThis = TEXT_CreateEx(pCreateInfo->x0 + x0, pCreateInfo->y0 + y0, pCreateInfo->xSize, pCreateInfo->ySize,
                        hWinParent, (1<<1), pCreateInfo->Flags, pCreateInfo->Id, pCreateInfo->pName);
  return hThis;
}
