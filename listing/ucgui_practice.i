...
void ucGUI_Practice(void)
{
	...
	while(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0001))==1);
	delay_ms(20);
	while(1){
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0002))==1)
		{
			i++;
			if(i>1)i=0;
			delay_ms(300); 
