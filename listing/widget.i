#line 1 "..\\code\\uCGUI\\Widget\\WIDGET.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\WIDGET.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\WIDGET.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\WIDGET.c"
#line 25 "..\\code\\uCGUI\\Widget\\WIDGET.c"
#line 26 "..\\code\\uCGUI\\Widget\\WIDGET.c"
#line 1 "..\\code\\GUI\\GUI_inc\\GUI_Protected.h"
...
#line 27 "..\\code\\uCGUI\\Widget\\WIDGET.c"
#line 28 "..\\code\\uCGUI\\Widget\\WIDGET.c"
...
static void _UpdateChildPostions(GUI_HWIN hObj, int Diff) {
  WM_Obj* pObj;
  ;
  pObj = (WM_Obj*)((WM_Obj*)GUI_ALLOC_h2p(hObj));
...
int WIDGET__GetWindowSizeX(GUI_HWIN hWin) {
  WIDGET* pWidget = ((WIDGET*)GUI_ALLOC_h2p(hWin));
  if (pWidget->State & (1<<3)) {
...
void WIDGET_SetState(GUI_HWIN hObj, int State) {
  WIDGET* pWidget;
  ;
  pWidget = ((WIDGET*)GUI_ALLOC_h2p(hObj));
...
void WIDGET_AndState(GUI_HWIN hObj, int Mask) {
  unsigned short StateNew;
  if (hObj) {
    WIDGET* pWidget;
    ;
    pWidget = ((WIDGET*)GUI_ALLOC_h2p(hObj));
...
int WIDGET_HandleActive(GUI_HWIN hObj, WM_MESSAGE* pMsg) {
  ...
  WIDGET* pWidget = ((WIDGET*)GUI_ALLOC_h2p(hObj));
  switch (pMsg->MsgId) {
  case 0x0300 + 0:
  ...
  case 31:
    if (pMsg->Data.v == 1) {
      WIDGET_SetState(hObj, pWidget->State |  (1<<0));
      Notification = 8;
    } else {
      WIDGET_SetState(hObj, pWidget->State & ~(1<<0));
      Notification = 9;
    ...
    return 0;
  case 32:
    pMsg->Data.v = (pWidget->State & (1<<4)) ? 1 : 0;                
    return 0;                          
  case 20:
...
void WIDGET__SetScrollState(GUI_HWIN hWin, const WM_SCROLL_STATE* pVState, const WM_SCROLL_STATE* pHState) {
  GUI_HWIN hScroll;
   
  hScroll = WM_GetDialogItem(hWin, 0xFE);
  WM_SetScrollState(hScroll, pVState);
   
  hScroll = WM_GetDialogItem(hWin, 0xFF);
...
void WIDGET__EFFECT_DrawDown(WIDGET* pWidget) {
  WIDGET__EFFECT_DrawDownRect(pWidget, 0);
}
