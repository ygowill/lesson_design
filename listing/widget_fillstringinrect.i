#line 1 "..\\code\\uCGUI\\Widget\\WIDGET_FillStringInRect.c"
...
#line 21 "..\\code\\uCGUI\\Widget\\WIDGET_FillStringInRect.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\WIDGET_FillStringInRect.c"
...
#line 27 "..\\code\\uCGUI\\Widget\\WIDGET_FillStringInRect.c"
...
#line 28 "..\\code\\uCGUI\\Widget\\WIDGET_FillStringInRect.c"
    ...
    if (*pText) {              
      const GUI_RECT* pOldClipRect;
...

        {
          ...
          GUI_ClearRect(pFillRect->x0, pFillRect->y0, pFillRect->x1, rText.y0 - 1);  
          GUI_ClearRect(pFillRect->x0, rText.y0,      rText.x0 - 1 , rText.y1);      
          GUI_ClearRect(rText.x1 + 1,  rText.y0,      pFillRect->x1, rText.y1);      
          GUI_ClearRect(pFillRect->x0, rText.y1 + 1,  pFillRect->x1, pFillRect->y1); 
        }
