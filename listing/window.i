#line 1 "..\\code\\uCGUI\\Widget\\WINDOW.c"
...
#line 22 "..\\code\\uCGUI\\Widget\\WINDOW.c"
...
#line 23 "..\\code\\uCGUI\\Widget\\WINDOW.c"
...
#line 24 "..\\code\\uCGUI\\Widget\\WINDOW.c"
...
GUI_COLOR WINDOW__DefaultBkColor = 0xC0C0C0;
...
static void _OnChildHasFocus(GUI_HWIN hWin, WINDOW_OBJ* pObj, const WM_MESSAGE* pMsg) {
  if (pMsg->Data.p) {
...
static void _cb(WM_MESSAGE* pMsg) {
  ...
  WM_CALLBACK* cb;
  hObj = pMsg->hWin;
  pObj = (WINDOW_OBJ*)((WM_Obj*)GUI_ALLOC_h2p(hObj));
  cb   = pObj->cb;
  switch (pMsg->MsgId) {
  case 42:
    if (pMsg->Data.p) {                            
...
GUI_HWIN WINDOW_CreateIndirect(const GUI_WIDGET_CREATE_INFO* pCreateInfo, GUI_HWIN hWinParent, int x0, int y0, WM_CALLBACK* cb) {
  ...
  if (hObj) {
    ...
    ;
    pObj = (WINDOW_OBJ*)((WM_Obj*)GUI_ALLOC_h2p(hObj));
    WIDGET__Init(&pObj->Widget, pCreateInfo->Id, (1<<4));
    pObj->cb             = cb;
