...
#line 22 "..\\code\\uCGUI\\WM\\WM.c"

#line 1 "..\\code\\uCGUI\\WM\\WM_Intern_ConfDep.h"
...
#line 1 "..\\code\\uCGUI\\WM\\WM_Intern.h"
...
#line 26 "..\\code\\uCGUI\\WM\\WM.h"
#line 1 "..\\code\\uCGUI\\WM\\WM_GUI.h"
...
#line 50 "..\\code\\uCGUI\\WM\\WM_GUI.h"
...
#line 24 "..\\code\\uCGUI\\WM\\WM_Intern.h"
...
#line 57 "..\\code\\GUI\\GUI_inc\\WM_GUI.h"
...
#line 25 "..\\code\\uCGUI\\WM\\WM_Intern.h"
...
#line 58 "..\\code\\uCGUI\\WM\\WM_Intern.h"
...
#line 74 "..\\code\\uCGUI\\WM\\WM_Intern.h"
...
extern WM_CRITICAL_HANDLE     WM__CHWinLast;
 ...
 unsigned short     WM__NumWindows;
 unsigned short     WM__NumInvalidWindows;
 GUI_HWIN WM__FirstWin;
...
#line 24 "..\\code\\uCGUI\\WM\\WM_Intern_ConfDep.h"
 ...
 GUI_HWIN   WM__ahDesktopWin[1];    
 GUI_COLOR WM__aBkColor[1];        
...
unsigned short                    WM__CreateFlags;
GUI_HWIN                WM__hCapture;
GUI_HWIN                WM__hWinFocus;
char                   WM__CaptureReleaseAuto;
WM_tfPollPID*          WM_pfPollPID;
unsigned char                     WM__PaintCallbackCnt;       
GUI_PID_STATE          WM_PID__StateLast;


  int                    WM__TransWindowCnt;
  GUI_HWIN                WM__hATransWindow;
...
static void _CheckCriticalHandles(GUI_HWIN hWin) {
...
static int _DesktopHandle2Index(GUI_HWIN hDesktop) {
#line 129 "..\\code\\uCGUI\\WM\\WM.c"
...
static void _Invalidate1Abs(GUI_HWIN hWin, const GUI_RECT*pRect) {
  GUI_RECT r;
  WM_Obj* pWin;
  int Status;
  pWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin));
  Status = pWin->Status;
  if ((Status & (1<<1)) == 0) {
    return;    
  }
  if ((Status & ((1<<0) | (1<<11))) == (1<<0)) {
    return;    
  }
...
static GUI_HWIN _GethDrawWin(void) {
  GUI_HWIN h;
...
static void _SetClipRectUserIntersect(const GUI_RECT* prSrc) {
  if (GUI_Context.WM__pUserClipRect == 0) {
    LCD_SetClipRectEx(prSrc);
  } else {
    GUI_RECT r;
    r = *GUI_Context.WM__pUserClipRect;             
    WM__Client2Screen(((WM_Obj*)GUI_ALLOC_h2p(_GethDrawWin())), &r);      
...
void  WM__ActivateClipRect(void) {
  if (WM_IsActive) {
    ...
    GUI_RECT r;
    WM_Obj *pAWin;
    pAWin = ((WM_Obj*)GUI_ALLOC_h2p(GUI_Context . hAWin));
    r = pAWin->Rect;
...
void WM__InsertWindowIntoList(GUI_HWIN hWin, GUI_HWIN hParent) {
  ...
  if (hParent) {
    ...
    pParent = ((WM_Obj*)GUI_ALLOC_h2p(hParent));
    OnTop   = pWin->Status & (1<<3);
    ...
    do {
      ...
      pNext = ((WM_Obj*)GUI_ALLOC_h2p(hNext));
      if (!OnTop) {
        if (pNext->Status & (1<<3)) {
          pi->hNext = hWin;
          pWin->hNext = hNext;
...
void WM__DetachWindow(GUI_HWIN hWin) {
  WM_Obj* pWin;
  GUI_HWIN hParent;
  pWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin));
  hParent = pWin->hParent;
...
static void _DeleteAllChildren(GUI_HWIN hChild) {
  while (hChild) {
    WM_Obj* pChild = ((WM_Obj*)GUI_ALLOC_h2p(hChild));
    GUI_HWIN hNext = pChild->hNext;
...
int WM__IsWindow(GUI_HWIN hWin) {
  GUI_HWIN iWin;
  for (iWin = WM__FirstWin; iWin; iWin = ((WM_Obj*)GUI_ALLOC_h2p(iWin))->hNextLin) {
    if (iWin == hWin) {
      return 1;
    }
  }
...
void WM__RemoveFromLinList(GUI_HWIN hWin) {
  ...
  for (hiWin = WM__FirstWin; hiWin; ) {
    piWin = ((WM_Obj*)GUI_ALLOC_h2p(hiWin));
    hNext = piWin->hNextLin;
    if (hNext == hWin) {
      piWin->hNextLin = ((WM_Obj*)GUI_ALLOC_h2p(hWin))->hNextLin;
      break;
    }
    hiWin = hNext;
  }
...
static void _AddToLinList(GUI_HWIN hNew) {
  WM_Obj* pFirst;
  WM_Obj* pNew;
  if (WM__FirstWin) {
    pFirst = ((WM_Obj*)GUI_ALLOC_h2p(WM__FirstWin));
    pNew   = ((WM_Obj*)GUI_ALLOC_h2p(hNew));
...
static void _Findy1(GUI_HWIN iWin, GUI_RECT* pRect, GUI_RECT* pParentRect) {
  WM_Obj* pWin;
  for (; iWin; iWin = pWin->hNext) { 
    int Status = (pWin = ((WM_Obj*)GUI_ALLOC_h2p(iWin)))->Status;
      ...
      if (GUI_RectsIntersect(pRect, &rWinClipped)) {
        if ((Status & (1<<0)) == 0) {
          if (pWin->Rect.y0 > pRect->y0) {
            if (rWinClipped . y0 - 1<pRect->y1) pRect->y1=rWinClipped . y0 - 1;       
          } else {
            if (rWinClipped . y1<pRect->y1) pRect->y1=rWinClipped . y1;         
          }
        } else {
          ...
          for (hChild = pWin->hFirstChild; hChild; hChild = pChild->hNext) {
            pChild = ((WM_Obj*)GUI_ALLOC_h2p(hChild));
...
static int _Findx0(GUI_HWIN hWin, GUI_RECT* pRect, GUI_RECT* pParentRect) {
  WM_Obj* pWin;
  int r = 0;
  for (; hWin; hWin = pWin->hNext) { 
    int Status = (pWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin)))->Status;
    if (Status & (1<<1)) {            
      GUI_RECT rWinClipped;                
      if (pParentRect) {
        GUI__IntersectRects(&rWinClipped, &pWin->Rect, pParentRect);
...
static void _Findx1(GUI_HWIN hWin, GUI_RECT* pRect, GUI_RECT* pParentRect) {
  WM_Obj* pWin;
  for (; hWin; hWin = pWin->hNext) { 
    int Status = (pWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin)))->Status;
    if (Status & (1<<1)) {            
...
void WM_SendMessage(GUI_HWIN hWin, WM_MESSAGE* pMsg) {
  if (hWin) {
    WM_Obj* pWin;
    ;
    pWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin));
...
void WM_InvalidateArea(const GUI_RECT* pRect) {
  ...
  for (hWin = WM__FirstWin; hWin; hWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin))->hNextLin) {
...
GUI_HWIN WM_CreateWindowAsChild( int x0, int y0, int width, int height
                               ,GUI_HWIN hParent, unsigned short Style, WM_CALLBACK* cb
                               ,int NumExtraBytes) {
  WM_Obj* pWin;
  GUI_HWIN hWin;
  ;
  ...
  if (hParent == ((signed short)-1)) {
    hParent = (0);
  }  
  if (hParent) {
    WM_Obj* pParent = ((WM_Obj*)GUI_ALLOC_h2p(hParent));
    x0 += pParent->Rect.x0;
    y0 += pParent->Rect.y0;
    if (width==0) {
  ...
  if ((hWin = (GUI_HWIN) GUI_ALLOC_AllocZero(NumExtraBytes + sizeof(WM_Obj))) == 0) {
    ;
  } else {
    WM__NumWindows++;
    pWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin));
...
GUI_HWIN WM_CreateWindow(int x0, int y0, int width, int height, unsigned short Style, WM_CALLBACK* cb, int NumExtraBytes) {
  return WM_CreateWindowAsChild(x0,y0,width,height, 0  ,  Style, cb, NumExtraBytes);
}
...
#line 982 "..\\code\\uCGUI\\WM\\WM.c"
  pObj = ((WM_Obj*)GUI_ALLOC_h2p(hWin));
  LCD_SetClipRectMax();              
...
NextStripe:   
  ...
  if (r.x0 == _ClipContext.ClientRect.x0) {
    ...
    for (hParent = GUI_Context.hAWin; hParent; hParent = pParent->hParent) {
      pParent = ((WM_Obj*)GUI_ALLOC_h2p(hParent));
      _Findy1(pParent->hNext, &r, 0);
    }
     
    _Findy1(pAWin->hFirstChild, &r, 0);
  }
...
#line 1093 "..\\code\\uCGUI\\WM\\WM.c"
  {
    hParent = GUI_Context.hAWin;
  }
  for (; hParent; hParent = pParent->hParent) {
    pParent = ((WM_Obj*)GUI_ALLOC_h2p(hParent));
    if (_Findx0(pParent->hNext, &r, 0)) {
      goto Find_x0;
    }
  }
   
  if (_Findx0(pAWin->hFirstChild, &r, 0)) {
    goto Find_x0;
  }
...
#line 1127 "..\\code\\uCGUI\\WM\\WM.c"
  {
    hParent = GUI_Context.hAWin;
  }
  for (; hParent; hParent = pParent->hParent) {
    pParent = ((WM_Obj*)GUI_ALLOC_h2p(hParent));
    _Findx1(pParent->hNext, &r, 0);
  }
   
  _Findx1(pAWin->hFirstChild, &r, 0);
...
int WM__InitIVRSearch(const GUI_RECT* pMaxRect) {
  ...
  if (GUI_Context.WM__pUserClipRect) {
    ...
    GUI_RECT rUser = *(GUI_Context.WM__pUserClipRect);
      ...
      if (WM__hATransWindow) {
        pWin = ((WM_Obj*)GUI_ALLOC_h2p(WM__hATransWindow));
      }   
...
void WM_SetDefault(void) {
  GL_SetDefault();
  GUI_Context.WM__pUserClipRect = 0;    
}
...
static void _Paint1(GUI_HWIN hWin, WM_Obj* pWin) {
  int Status = pWin->Status;
   
  if ((pWin->cb != 0)  && (Status & (1<<1))) {
    WM_MESSAGE Msg;
    ...
    if (Status & (1<<12)) {
      ...
      { if (WM__InitIVRSearch(&pWin->InvalidRect)) do { {
        Msg.hWin   = hWin;
        Msg.MsgId  = 0x000F;
        Msg.Data.p = (GUI_RECT*)&pWin->InvalidRect;
        WM_SetDefault();
...
static int _Paint1Trans(GUI_HWIN hWin, WM_Obj* pWin) {
  int xPrev, yPrev;
  WM_Obj* pAWin = ((WM_Obj*)GUI_ALLOC_h2p(GUI_Context . hAWin));
...
static void _PaintTransTopSiblings(GUI_HWIN hWin, WM_Obj* pWin) {
  GUI_HWIN hParent;
  WM_Obj* pParent;
  hParent = pWin->hParent;
  hWin = pWin->hNext;
  while (hParent) {  
    for (; hWin; hWin = pWin->hNext) {
      ...
      if ((pWin->Status & ((1<<0) | (1<<1))) ==  ((1<<0) | (1<<1))) {
...
static int _Paint(GUI_HWIN hWin, WM_Obj* pWin) {
  int Ret = 0;
  if (pWin->Status & (1<<5)) {
    if (pWin->cb) {
...
static void _DrawNext(void) {
  int UpdateRem = 1;
  GUI_HWIN iWin = (NextDrawWin == (0)) ? WM__FirstWin : NextDrawWin;
  GUI_CONTEXT ContextOld;
  GUI_SaveContext_W(&ContextOld);
   
  for (; iWin && UpdateRem; ) {
    WM_Obj* pWin = ((WM_Obj*)GUI_ALLOC_h2p(iWin));
    if (_Paint(iWin, pWin)) {
      UpdateRem--;   
    }
    iWin = pWin->hNextLin;
  ...
  case 0x000F:
    {
      ...
      if (WM__aBkColor[LayerIndex] != 0xFFFFFFF) {
...
void WM_DefaultProc(WM_MESSAGE* pMsg) {
  ...
  WM_Obj* pWin = ((WM_Obj*)GUI_ALLOC_h2p(hWin));
...
void WM_Init(void) {
	if (!_IsInited) {
      ...
      WM__ahDesktopWin[0] = WM_CreateWindow(0, 0, 4095, 4095, (1<<1), cbBackWin, 0);
      WM__aBkColor[0] = 0xFFFFFFF;
      WM_InvalidateWindow(WM__ahDesktopWin[0]);  
#line 1717 "..\\code\\uCGUI\\WM\\WM.c"
