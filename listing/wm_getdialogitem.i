#line 1 "..\\code\\uCGUI\\WM\\WM_GetDialogItem.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WM_GetDialogItem.c"
...
static GUI_HWIN _GetDialogItem(GUI_HWIN hWin, int Id) {
  GUI_HWIN hi;
  GUI_HWIN r =0;
  ...
  while (hi) {
    ...
    hi = ((WM_Obj*)GUI_ALLOC_h2p(hi))->hNext;
  }
  return r;
}
