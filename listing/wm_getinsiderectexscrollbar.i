#line 1 "..\\code\\uCGUI\\WM\\WM_GetInsideRectExScrollbar.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WM_GetInsideRectExScrollbar.c"
...
void WM_GetInsideRectExScrollbar(GUI_HWIN hWin, GUI_RECT* pRect) {
  ...
  GUI_HWIN hBarV, hBarH;
  unsigned short WinFlags;
  if (hWin) {
    if (pRect) {
      hBarH = WM_GetDialogItem(hWin, 0xFF);
      hBarV = WM_GetDialogItem(hWin, 0xFE);
      WM_GetWindowRectEx(hWin, &rWin);      
