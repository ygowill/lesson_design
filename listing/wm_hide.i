#line 1 "..\\code\\uCGUI\\WM\\WM_Hide.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WM_Hide.c"

#line 24 "..\\code\\uCGUI\\WM\\WM_Hide.c"
...
void WM_HideWindow(GUI_HWIN hWin) {
  if (hWin) {
    ...
    if (pWin->Status & (1<<1)) {
      ...
      WM__InvalidateAreaBelow(&((WM_Obj*)GUI_ALLOC_h2p(hWin))->Rect, hWin);
