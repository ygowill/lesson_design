#line 1 "..\\code\\uCGUI\\WM\\WM_Move.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WM_Move.c"
...
static void _MoveDescendents(GUI_HWIN hWin, int dx, int dy) {
  WM_Obj* pWin;
  ...
  for (;hWin; hWin = pWin->hNext) {
    ...
    _MoveDescendents(pWin->hFirstChild, dx, dy);   
    WM__SendMsgNoData(hWin, 0x0003);
  }
}
