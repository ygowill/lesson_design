#line 1 "..\\code\\uCGUI\\WM\\WM_ResizeWindow.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WM_ResizeWindow.c"
...
#line 22 "..\\code\\uCGUI\\WM\\WM_ResizeWindow.c"

#line 25 "..\\code\\uCGUI\\WM\\WM_ResizeWindow.c"
...
void WM_ResizeWindow(GUI_HWIN hWin, int dx, int dy) {
  ...
  rNew = rOld;
  if (dx) {
    if ((pWin->Status & (1<<7)) && (!(pWin->Status & (1<<9)))) {
      rNew.x0 -= dx;
    } else {
      rNew.x1 += dx;
    }
  ...
  if (dy) {
    if ((pWin->Status & (1<<8)) && (!(pWin->Status & (1<<10)))) {
      rNew.y0 -= dy;
    } else {
      rNew.y1 += dy;
    }
