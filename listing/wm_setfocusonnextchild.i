#line 1 "..\\code\\uCGUI\\WM\\WM_SetFocusOnNextChild.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WM_SetFocusOnNextChild.c"
...
static GUI_HWIN _GetNextChild(GUI_HWIN hParent, GUI_HWIN hChild) {
  GUI_HWIN hObj = 0;
  WM_Obj* pObj;
  if (hChild) {
    pObj = ((WM_Obj*)GUI_ALLOC_h2p(hChild));
    hObj = pObj->hNext;
  }
  if (!hObj) {
    pObj = ((WM_Obj*)GUI_ALLOC_h2p(hParent));
...
static GUI_HWIN _SetFocusOnNextChild(GUI_HWIN hParent) {
  GUI_HWIN hChild, hWin;
