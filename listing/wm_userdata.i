#line 1 "..\\code\\uCGUI\\WM\\WM_UserData.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WM_UserData.c"
...
#line 22 "..\\code\\uCGUI\\WM\\WM_UserData.c"
...
static int _CalcNumBytes(GUI_HWIN hWin, int NumBytes) {
...
int WM_GetUserData(GUI_HWIN hWin, void* pDest, int NumBytes) {
  if (hWin) {
    WM_Obj *pWin;
...
int WM_SetUserData(GUI_HWIN hWin, const void* pSrc, int NumBytes) {
  if (hWin) {
    WM_Obj *pWin;
    NumBytes = _CalcNumBytes(hWin, NumBytes);
    ;
