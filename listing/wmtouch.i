#line 1 "..\\code\\uCGUI\\WM\\WMTouch.c"
...
#line 21 "..\\code\\uCGUI\\WM\\WMTouch.c"
...
#line 22 "..\\code\\uCGUI\\WM\\WMTouch.c"
#line 23 "..\\code\\uCGUI\\WM\\WMTouch.c"
...
static GUI_HWIN _Screen2Win(GUI_PID_STATE* pState) {
  if (WM__hCapture == 0) {
  ...
  if ((WM_PID__StateLast.x != StateNew.x) || (WM_PID__StateLast.y != StateNew.y) || (WM_PID__StateLast.Pressed != StateNew.Pressed)) {
    ...
    if (WM__IsInModalArea(CHWin.hWin)) {
      ...
      if ((WM_PID__StateLast.Pressed != StateNew.Pressed) && CHWin.hWin) {
        ...
        WM_Obj* pWin;
        pWin = ((WM_Obj*)GUI_ALLOC_h2p(CHWin . hWin));
...
#line 231 "..\\code\\uCGUI\\WM\\WMTouch.c"
    }
